...
#define SOUND_ACTION_QUICKSAND_STEP              /* 0x042E0080 */ SOUND_ARG_LOAD(SOUND_BANK_ACTION,   0x2E, 0xFF, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
...
#define SOUND_GENERAL_BOX_LANDING_2 SOUND_GENERAL_BOX_LANDING_UNUSED
...
#define SOUND_GENERAL_COZIES_FLIPPER_CLICK                        SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x32, 0xC0, SOUND_DISCRETE) // unverified, unused
...
#define SOUND_GENERAL_METAL_POUND SOUND_GENERAL_ELEVATOR_LAND
...
#define SOUND_GENERAL_CRAZY_BOX_BOING_SLOW   SOUND_GENERAL_BOING1
#define SOUND_GENERAL_MONEYBAG_BOING_LOWPRIO SOUND_GENERAL_BOING2_LOWPRIO
#define SOUND_GENERAL_CRAZY_BOX_BOING_FAST   SOUND_GENERAL_BOING2
...
#define SOUND_CUSTOM_AWOOGA               /* 0x045F8080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,   0x76, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_CUSTOM_CARTOON_RUN               /* 0x045F8080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,   0x77, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_CUSTOM_WARP_BOX_IN                 /* 0x045F8080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x78, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_CUSTOM_WARP_BOX_OUT                /* 0x045F8080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x79, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)

#define SOUND_CUSTOM_COIN_DOG_ROO                /* 0x045F8080 */ SOUND_ARG_LOAD(SOUND_BANK_GENERAL,  0x7A, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
#define SOUND_CUSTOM_2639BARK SOUND_CUSTOM_COIN_DOG_ROO
...
#define SOUND_OBJ_CANNON4 SOUND_OBJ_WATER_BOMB_CANNON
...
#define SOUND_MENU_DOG_ROO                       /* 0x045F8080 */ SOUND_ARG_LOAD(SOUND_BANK_MENU,  0x40, 0x80, SOUND_NO_PRIORITY_LOSS | SOUND_DISCRETE)
