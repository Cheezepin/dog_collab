...
const LevelScript level_bob_entry[] = {
	...
	AREA(3, bob_area_3),
		...
		OBJECT_WITH_ACTS(MODEL_WOODEN_SIGNPOST, 44, -230, -1565, 0, 73, 0, 0x00000000, bhvMessagePanel, ACT_1 | ACT_2 | ACT_3 | ACT_4 | ACT_5),
	...
	AREA(4, bob_area_4),
		...
		OBJECT_WITH_ACTS(MODEL_TOAD, -3262, -218, -1309, 0, 0, 0, (_2639DIAG_A3RoomToadGibSoda << 16), bhvToadMessage, ACT_1 | ACT_2 | ACT_3 | ACT_4 | ACT_5),
	...
	AREA(5, bob_area_5),
		...
		OBJECT(MODEL_TOAD, 793, -488, -2379, 0, 0, 0, 0x00000000, bhvToadMessage),
