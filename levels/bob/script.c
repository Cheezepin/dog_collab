...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_NONE, -8509, -3991, 30, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
	...
	AREA(2, bob_area_2),
		...
		OBJECT(MODEL_ELEV2639, -2375, 77, 687, 0, 0, 0, 1 << 16, bhv2639elevator),
		OBJECT(MODEL_1UP, -406, 77, 381, 0, 0, 0, 0x00000000, bhv2639cane),
		MARIO_POS(0x01, 0, 0, 200, 0),
		OBJECT(MODEL_TOAD, 1158, 76, 1107, 0, 51, 0, _2639DIAG_A1LobbyNPCSuggester << 24, bhvToadMessage),
		OBJECT(MODEL_TOAD, 2165, 376, -34, 0, 0, 0, _2639DIAG_A1LobbyToadGreeter << 24, bhvToadMessage),
		OBJECT(MODEL_1UP, -1195, 77, -309, 0, 0, 0, 0x00000000, bhv2639glasses),
