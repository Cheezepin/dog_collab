...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_NONE, 1111, -2431, 5165, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, 1111, -2431, 5165),
	...
	AREA(2, bob_area_2),
		...
		OBJECT_WITH_ACTS(MODEL_TOAD, 1135, 1, 1058, 0, 0, 0, (_2639DIAG_A1LobbyToadGreeter << 16), bhvToadMessage, ACT_1),
		...
		OBJECT_WITH_ACTS(MODEL_ELEV2639, -5, 0, -2848, 0, 0, 0, (3 << 16), bhv2639elevator, ACT_5),
		OBJECT_WITH_ACTS(MODEL_ELEV2639, -5, 0, -2848, 0, 0, 0, (3 << 16), bhv2639elevator, ACT_5),
	...
	AREA(4, bob_area_4),
		...
		OBJECT(MODEL_TOAD, -3262, -218, -1309, 0, 0, 0, (_2639DIAG_A3RoomToadGibSoda << 16), bhvToadMessage),
