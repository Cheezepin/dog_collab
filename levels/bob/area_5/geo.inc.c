...
const GeoLayout bob_area_5_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT_INTER, -409, -880, 547, bob_dl_Plane_003_mesh_layer_7),
		GEO_OPEN_NODE(),
...
const GeoLayout bob_area_5[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				GEO_CAMERA(CAMERA_MODE_8_DIRECTIONS, 113682, 0, 0, 113682, -100, 0, geo_camera_main),
				GEO_OPEN_NODE(),
