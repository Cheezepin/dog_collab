...
const GeoLayout bob_area_2_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -373, 0, -2258, bob_dl_Plane_mesh_layer_1),
		GEO_OPEN_NODE(),
...
const GeoLayout bob_area_2[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				GEO_CAMERA(CAMERA_MODE_8_DIRECTIONS, -419, 2484, -2154, -419, 3484, -2154, geo_camera_main),
				GEO_OPEN_NODE(),
