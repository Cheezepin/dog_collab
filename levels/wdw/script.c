...
const LevelScript level_wdw_entry[] = {
	...
	AREA(1, wdw_area_1),
		...
		OBJECT(MODEL_NONE, -5250, 3813, -1928, 0, 0, 0, (1 << 16), bhvCoinFormation),
		...
		OBJECT(MODEL_BOWLING_BALL, 472, 7094, -4721, 0, 0, 0, 0x00000000, bhvFireSpitter),
		OBJECT(MODEL_BOWLING_BALL, 3280, 7094, -6522, 0, 0, 0, 0x00000000, bhvFireSpitter),
		OBJECT(MODEL_BOWLING_BALL, 3833, 7094, -3406, 0, 0, 0, 0x00000000, bhvFireSpitter),
		OBJECT(MODEL_BOWLING_BALL, 2133, 7094, -4246, 0, 0, 0, 0x00000000, bhvFireSpitter),
		OBJECT(MODEL_BOWLING_BALL, 2062, 7094, -5646, 0, 0, 0, 0x00000000, bhvFireSpitter),
		OBJECT(MODEL_BOWLING_BALL, 3704, 7094, -4758, 0, 0, 0, 0x00000000, bhvFireSpitter),
		...
		OBJECT(MODEL_RED_COIN, -5526, 4251, -1892, 0, 0, 0, 0x00000000, bhvRedCoin),
		...
		OBJECT(MODEL_NONE, 2264, 4509, -4815, 0, 0, 0, (1 << 24), bhvStar),
		OBJECT(MODEL_NONE, -6252, 5291, -1879, 0, 0, 0, (2 << 24), bhvStar),
		...
		OBJECT(MODEL_TREE_NUT, -4977, 5383, -1926, 0, 0, 0, 0x00000000, bhvTreeNut),
