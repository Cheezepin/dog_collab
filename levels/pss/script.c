...
const LevelScript level_pss_entry[] = {
	...
	AREA(1, pss_area_1),
		...
		OBJECT(MODEL_PINWHEEL, 11459, 1205, -4316, -90, 0, 0, 0x00030000, bhvPinwheel),
		...
		OBJECT(MODEL_CLOWN_CLOCK, 11577, 2105, -4838, 0, 0, -90, 0x00010000, bhvClownClockBits),
		OBJECT(MODEL_CLOWN_CLOCK, 12333, 2166, -5688, 0, 0, -90, 0x00010000, bhvClownClockBits),
		OBJECT(MODEL_CLOWN_CLOCK, 10854, 2248, -5688, 0, 0, -90, 0x00010000, bhvClownClockBits),
		...
		OBJECT(MODEL_DOG_BONE, 10602, 2349, -6021, 0, 90, 0, 0x00000000, bhvDogBone),
	...
	AREA(3, pss_area_3),
		...
		OBJECT(0x1F6, -4802, 0, 555, 0, 0, 0, (1 << 16), bhvLaserRingSpawner),
		OBJECT(0x1F6, 2, -1, 1273, 0, -90, 0, 0x00000000, bhvLaserRingSpawner),
