Lights1 ashpile_bits_Ash_lights = gdSPDefLights1(
	0x7F, 0x7F, 0x7F,
	0xFE, 0xFE, 0xFE, 0x28, 0x28, 0x28);

Gfx ashpile_bits_ash_ci4_aligner[] = {gsSPEndDisplayList()};
u8 ashpile_bits_ash_ci4[] = {
...
Gfx ashpile_bits_ash_ci4_pal_rgba16_aligner[] = {gsSPEndDisplayList()};
u8 ashpile_bits_ash_ci4_pal_rgba16[] = {
	0x29, 0x49, 0x21, 0x07, 0x29, 0x4b, 0x39, 0xcf, 
	0x21, 0x09, 0x31, 0x8b, 0x39, 0xcd, 0x42, 0x0f, 
	
};

Vtx ashpile_bits_Cylinder_002_mesh_layer_5_vtx_cull[8] = {
...
Vtx ashpile_bits_Cylinder_002_mesh_layer_5_vtx_0[50] = {
...
Gfx ashpile_bits_Cylinder_002_mesh_layer_5_tri_0[] = {
	gsSPVertex(ashpile_bits_Cylinder_002_mesh_layer_5_vtx_0 + 0, 30, 0),
	...
	gsSPVertex(ashpile_bits_Cylinder_002_mesh_layer_5_vtx_0 + 30, 20, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSP2Triangles(4, 5, 6, 0, 4, 6, 7, 0),
	gsSP2Triangles(8, 9, 10, 0, 8, 10, 11, 0),
...
Gfx mat_ashpile_bits_Ash[] = {
	...
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, ashpile_bits_ash_ci4_pal_rgba16),
	gsDPTileSync(),
	...
	gsDPPipeSync(),
	gsDPTileSync(),
	gsDPSetTextureImage(G_IM_FMT_CI, G_IM_SIZ_16b, 1, ashpile_bits_ash_ci4),
	...
	gsSPSetLights1(ashpile_bits_Ash_lights),
	gsSPEndDisplayList(),
};

Gfx mat_revert_ashpile_bits_Ash[] = {
	gsDPPipeSync(),
...
Gfx ashpile_bits_Cylinder_002_mesh_layer_5[] = {
	gsSPClearGeometryMode(G_LIGHTING),
	gsSPVertex(ashpile_bits_Cylinder_002_mesh_layer_5_vtx_cull + 0, 8, 0),
	gsSPSetGeometryMode(G_LIGHTING),
	gsSPCullDisplayList(0, 7),
	gsSPDisplayList(mat_ashpile_bits_Ash),
	gsSPDisplayList(ashpile_bits_Cylinder_002_mesh_layer_5_tri_0),
	gsSPDisplayList(mat_revert_ashpile_bits_Ash),
	gsSPEndDisplayList(),
};

Gfx ashpile_bits_material_revert_render_settings[] = {
	gsDPPipeSync(),
	gsSPSetGeometryMode(G_LIGHTING),
