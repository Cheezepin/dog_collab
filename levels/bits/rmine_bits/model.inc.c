Lights1 rmine_bits_camo_lights = gdSPDefLights1(
	0x4A, 0x4A, 0x4A,
	0x95, 0x95, 0x95, 0x28, 0x28, 0x28);

Lights1 rmine_bits_mine_scroll_lights = gdSPDefLights1(
	0x7F, 0x7F, 0x7F,
	0xFE, 0xFE, 0xFE, 0x28, 0x28, 0x28);

Gfx rmine_bits_camo_motos_ci8_aligner[] = {gsSPEndDisplayList()};
u8 rmine_bits_camo_motos_ci8[] = {
...
Gfx rmine_bits_camo_motos_ci8_pal_rgba16_aligner[] = {gsSPEndDisplayList()};
u8 rmine_bits_camo_motos_ci8_pal_rgba16[] = {
...
Gfx rmine_bits_mine_scroll_ci4_aligner[] = {gsSPEndDisplayList()};
u8 rmine_bits_mine_scroll_ci4[] = {
	0x00, 0x11, 0x00, 0x11, 0x00, 0x11, 0x00, 0x11, 
	
};

Gfx rmine_bits_mine_scroll_ci4_pal_rgba16_aligner[] = {gsSPEndDisplayList()};
u8 rmine_bits_mine_scroll_ci4_pal_rgba16[] = {
	0xf8, 0x01, 0xfd, 0xad, 
};

Vtx rmine_bits_Cylinder_006_mesh_layer_1_vtx_cull[8] = {
...
Vtx rmine_bits_Cylinder_006_mesh_layer_1_vtx_0[10] = {
...
Gfx rmine_bits_Cylinder_006_mesh_layer_1_tri_0[] = {
	gsSPVertex(rmine_bits_Cylinder_006_mesh_layer_1_vtx_0 + 0, 10, 0),
...
Vtx rmine_bits_Cylinder_006_mesh_layer_1_vtx_1[25] = {
...
Gfx rmine_bits_Cylinder_006_mesh_layer_1_tri_1[] = {
	gsSPVertex(rmine_bits_Cylinder_006_mesh_layer_1_vtx_1 + 0, 25, 0),
...
Gfx mat_rmine_bits_camo[] = {
	gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, ENVIRONMENT, TEXEL0, 0, SHADE, 0, 0, 0, 0, ENVIRONMENT),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsDPSetTextureLUT(G_TT_RGBA16),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, rmine_bits_camo_motos_ci8_pal_rgba16),
	gsDPTileSync(),
	...
	gsDPPipeSync(),
	gsDPTileSync(),
	gsDPSetTextureImage(G_IM_FMT_CI, G_IM_SIZ_8b_LOAD_BLOCK, 1, rmine_bits_camo_motos_ci8),
	...
	gsSPSetLights1(rmine_bits_camo_lights),
	gsSPEndDisplayList(),
};

Gfx mat_revert_rmine_bits_camo[] = {
	gsDPPipeSync(),
	gsDPSetTextureLUT(G_TT_NONE),
	gsSPEndDisplayList(),
};

Gfx mat_rmine_bits_mine_scroll[] = {
	gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, ENVIRONMENT, TEXEL0, 0, SHADE, 0, 0, 0, 0, ENVIRONMENT),
	gsDPSetTextureFilter(G_TF_POINT),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsDPSetTextureLUT(G_TT_RGBA16),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, rmine_bits_mine_scroll_ci4_pal_rgba16),
	gsDPTileSync(),
	gsDPSetTile(0, 0, 0, 256, 7, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 0, 0),
	gsDPLoadSync(),
	gsDPLoadTLUTCmd(7, 1),
	gsDPPipeSync(),
	gsDPTileSync(),
	gsDPSetTextureImage(G_IM_FMT_CI, G_IM_SIZ_16b, 1, rmine_bits_mine_scroll_ci4),
	...
	gsSPSetLights1(rmine_bits_mine_scroll_lights),
	gsSPEndDisplayList(),
};

Gfx mat_revert_rmine_bits_mine_scroll[] = {
	gsDPPipeSync(),
...
Gfx rmine_bits_Cylinder_006_mesh_layer_1[] = {
	gsSPClearGeometryMode(G_LIGHTING),
	gsSPVertex(rmine_bits_Cylinder_006_mesh_layer_1_vtx_cull + 0, 8, 0),
	gsSPSetGeometryMode(G_LIGHTING),
	gsSPCullDisplayList(0, 7),
	gsSPDisplayList(mat_rmine_bits_camo),
	gsSPDisplayList(rmine_bits_Cylinder_006_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_revert_rmine_bits_camo),
	gsSPDisplayList(mat_rmine_bits_mine_scroll),
	gsSPDisplayList(rmine_bits_Cylinder_006_mesh_layer_1_tri_1),
	gsSPDisplayList(mat_revert_rmine_bits_mine_scroll),
	gsSPEndDisplayList(),
};

Gfx rmine_bits_material_revert_render_settings[] = {
	gsDPPipeSync(),
	gsSPSetGeometryMode(G_LIGHTING),
