...
const LevelScript level_bits_entry[] = {
	...
	AREA(7, bits_area_7),
		WARP_NODE(0x0A, LEVEL_BITS, 0x07, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x01, LEVEL_BITS, 0x02, 0x02, WARP_NO_CHECKPOINT),
		WARP_NODE(32, LEVEL_BITS, 0x07, 32, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_RED_COIN, 7178, 14347, -400, 0, 90, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_WARP_BOX, -25751, 19081, 0, 0, 90, 0, (1 << 24) | (32 << 16), bhvWarpBox),
		OBJECT(MODEL_WARP_BOX, 6244, 16237, -533, 0, 90, 0, (0 << 24) | (33 << 16), bhvWarpBox),
		TERRAIN(bits_area_7_collision),
		ROOMS(bits_area_7_collision_rooms),
	...
	AREA(1, bits_area_1),
		WARP_NODE(0x0A, LEVEL_BITS, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x01, LEVEL_BITS, 0x08, 78, WARP_NO_CHECKPOINT),
		WARP_NODE(99, LEVEL_BITS, 0x08, 78, WARP_NO_CHECKPOINT),
	...
	AREA(8, bits_area_8),
		...
		WARP_NODE(78, LEVEL_BITS, 0x08, 78, WARP_NO_CHECKPOINT),
		WARP_NODE(79, LEVEL_BITS, 0x08, 79, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, -4080, 200, 2601, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		OBJECT(MODEL_WARP_BOX, -4087, 135, 2972, 0, 90, 0, (1 << 24) | (78 << 16), bhvWarpBox),
		OBJECT(MODEL_WARP_BOX, 8901, 1868, 8628, 0, 90, 0, (0 << 24) | (79 << 16), bhvWarpBox),
		OBJECT(MODEL_EXCLAMATION_BOX, -4079, 917, -1496, 0, 0, 0, (3 << 16), bhvExclamationBox),
		OBJECT(MODEL_WF_PALM_TREE, 2890, 2381, 5355, 0, 0, 0, 0x00000000, bhvPalmTreeBits),
		OBJECT(MODEL_WF_PALM_TREE, 391, 2689, -529, 0, 0, 0, 0x00000000, bhvPalmTreeBits),
		OBJECT(MODEL_WF_PALM_TREE, 7090, 4111, -2897, 0, 0, 0, 0x00000000, bhvPalmTreeBits),
		TERRAIN(bits_area_8_collision),
		ROOMS(bits_area_8_collision_rooms),
		MACRO_OBJECTS(bits_area_8_macro_objs),
		SET_BACKGROUND_MUSIC(0x00, SEQ_LEVEL_GRASS),
		TERRAIN_TYPE(TERRAIN_GRASS),
		/* Fast64 begin persistent block [area commands] */
		/* Fast64 end persistent block [area commands] */
	...
	AREA(5, bits_area_5),
		...
		OBJECT(MODEL_FWOOSH, 15765, 2759, 8079, 0, -105, 0, 0x00000000, bhvCloud),
