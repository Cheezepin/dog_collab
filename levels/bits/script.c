...
const LevelScript level_bits_entry[] = {
	...
	AREA(3, bits_area_3),
		...
		OBJECT(MODEL_ELEV2639, -5, -8266, -2848, 0, 0, 0, (0 << 24) | (39 << 16), bhv2639elevator),
		...
		OBJECT(MODEL_WARP_BOX, 342, -8150, 2489, 0, 0, 0, (1 << 24) | (1 << 16), bhvWarpBox),
		OBJECT(MODEL_WARP_BOX, 310, -9278, -2078, 0, 0, 0, (0 << 24) | (2 << 16), bhvWarpBox),
