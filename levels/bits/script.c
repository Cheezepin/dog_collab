...
const LevelScript level_bits_entry[] = {
	...
	AREA(4, bits_area_4),
		...
		OBJECT(MODEL_RED_COIN, 7178, 14347, -400, 0, 90, 0, 0x00000000, bhvRedCoin),
	...
	AREA(9, bits_area_9),
		WARP_NODE(0x0A, LEVEL_BITS, 9, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_BITS, 9, 1, WARP_NO_CHECKPOINT),
		WARP_NODE(1, LEVEL_BITS, 9, 1, WARP_NO_CHECKPOINT),
		WARP_NODE(2, LEVEL_BITS, 10, 1, WARP_NO_CHECKPOINT),
		...
		TERRAIN(bits_area_9_collision),
		MACRO_OBJECTS(bits_area_9_macro_objs),
		SET_BACKGROUND_MUSIC(0x00, SEQ_LEVEL_KOOPA_ROAD),
		TERRAIN_TYPE(TERRAIN_GRASS),
		/* Fast64 begin persistent block [area commands] */
		/* Fast64 end persistent block [area commands] */
	...
	AREA(11, bits_area_11),
		WARP_NODE(0x0A, LEVEL_BITS, 11, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_BITS, 11, 1, WARP_NO_CHECKPOINT),
		WARP_NODE(1, LEVEL_BITS, 11, 1, WARP_NO_CHECKPOINT),
		WARP_NODE(2, LEVEL_BITS, 12, 1, WARP_NO_CHECKPOINT),
		...
		TERRAIN(bits_area_11_collision),
		ROOMS(bits_area_11_collision_rooms),
		MACRO_OBJECTS(bits_area_11_macro_objs),
		SET_BACKGROUND_MUSIC(0x00, SEQ_LEVEL_KOOPA_ROAD),
	...
	AREA(5, bits_area_5),
		...
		OBJECT(MODEL_RED_COIN, 4467, 6801, 40, 0, 0, 0, 0x00000000, bhvRedCoin),
	...
	AREA(1, bits_area_1),
		...
		WARP_NODE(99, LEVEL_BITS, 10, 1, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_WARP_BOX, 4394, 3621, 10237, 0, 90, 0, (0 << 24) | (2 << 16), bhvWarpBox),
		OBJECT(MODEL_WARP_BOX, 2333, 384, -695, 0, 90, 0, (0 << 24) | (99 << 16), bhvWarpBox),
	...
	AREA(7, bits_area_7),
		...
		WARP_NODE(2, LEVEL_BITS, 9, 1, WARP_NO_CHECKPOINT),
	...
	AREA(10, bits_area_10),
		WARP_NODE(0x0A, LEVEL_BITS, 10, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_BITS, 10, 1, WARP_NO_CHECKPOINT),
		WARP_NODE(1, LEVEL_BITS, 10, 1, WARP_NO_CHECKPOINT),
		WARP_NODE(2, LEVEL_BITS, 11, 1, WARP_NO_CHECKPOINT),
		...
		TERRAIN(bits_area_10_collision),
		MACRO_OBJECTS(bits_area_10_macro_objs),
		SET_BACKGROUND_MUSIC(0x00, SEQ_LEVEL_KOOPA_ROAD),
		TERRAIN_TYPE(TERRAIN_GRASS),
		/* Fast64 begin persistent block [area commands] */
		/* Fast64 end persistent block [area commands] */
