Lights1 ashpile2_bits_Ash_lights = gdSPDefLights1(
	0x7F, 0x7F, 0x7F,
	0xFE, 0xFE, 0xFE, 0x28, 0x28, 0x28);

Gfx ashpile2_bits_ash_ci4_aligner[] = {gsSPEndDisplayList()};
u8 ashpile2_bits_ash_ci4[] = {
...
Gfx ashpile2_bits_ash_ci4_pal_rgba16_aligner[] = {gsSPEndDisplayList()};
u8 ashpile2_bits_ash_ci4_pal_rgba16[] = {
	0x29, 0x49, 0x21, 0x07, 0x29, 0x4b, 0x39, 0xcf, 
	0x21, 0x09, 0x31, 0x8b, 0x39, 0xcd, 0x42, 0x0f, 
	
};

Vtx ashpile2_bits_Cylinder_003_mesh_layer_1_vtx_cull[8] = {
...
Vtx ashpile2_bits_Cylinder_003_mesh_layer_1_vtx_0[25] = {
...
Gfx ashpile2_bits_Cylinder_003_mesh_layer_1_tri_0[] = {
	gsSPVertex(ashpile2_bits_Cylinder_003_mesh_layer_1_vtx_0 + 0, 25, 0),
...
Vtx ashpile2_bits_Cylinder_003_mesh_layer_5_vtx_cull[8] = {
	{{{-151, 0, 128},0, {-16, -16},{0x0, 0x0, 0x0, 0x0}}},
	{{{-151, 83, 128},0, {-16, -16},{0x0, 0x0, 0x0, 0x0}}},
	{{{-151, 83, -159},0, {-16, -16},{0x0, 0x0, 0x0, 0x0}}},
	{{{-151, 0, -159},0, {-16, -16},{0x0, 0x0, 0x0, 0x0}}},
...
Vtx ashpile2_bits_Cylinder_003_mesh_layer_5_vtx_0[25] = {
...
Gfx ashpile2_bits_Cylinder_003_mesh_layer_5_tri_0[] = {
	gsSPVertex(ashpile2_bits_Cylinder_003_mesh_layer_5_vtx_0 + 0, 25, 0),
...
Gfx mat_ashpile2_bits_Ash2[] = {
	gsDPPipeSync(),
	gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, ENVIRONMENT, 0, 0, 0, TEXEL0, 0, 0, 0, ENVIRONMENT),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsDPSetTextureLUT(G_TT_RGBA16),
	gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, ashpile2_bits_ash_ci4_pal_rgba16),
	gsDPTileSync(),
	...
	gsDPPipeSync(),
	gsDPTileSync(),
	gsDPSetTextureImage(G_IM_FMT_CI, G_IM_SIZ_16b, 1, ashpile2_bits_ash_ci4),
...
Gfx mat_revert_ashpile2_bits_Ash2[] = {
	gsDPPipeSync(),
	gsDPSetTextureLUT(G_TT_NONE),
	gsSPEndDisplayList(),
};

Gfx mat_ashpile2_bits_Ash[] = {
	gsDPPipeSync(),
	...
	gsDPSetTile(G_IM_FMT_CI, G_IM_SIZ_4b, 2, 0, 0, 0, G_TX_WRAP | G_TX_NOMIRROR, 5, 0, G_TX_WRAP | G_TX_NOMIRROR, 5, 0),
	gsDPSetTileSize(0, 0, 0, 124, 124),
	gsSPSetLights1(ashpile2_bits_Ash_lights),
	gsSPEndDisplayList(),
};

Gfx mat_revert_ashpile2_bits_Ash[] = {
	gsDPPipeSync(),
...
Gfx ashpile2_bits_Cylinder_003_mesh_layer_1[] = {
	gsSPClearGeometryMode(G_LIGHTING),
	gsSPVertex(ashpile2_bits_Cylinder_003_mesh_layer_1_vtx_cull + 0, 8, 0),
	gsSPSetGeometryMode(G_LIGHTING),
	gsSPCullDisplayList(0, 7),
	gsSPDisplayList(mat_ashpile2_bits_Ash2),
	gsSPDisplayList(ashpile2_bits_Cylinder_003_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_revert_ashpile2_bits_Ash2),
	gsSPEndDisplayList(),
};

Gfx ashpile2_bits_Cylinder_003_mesh_layer_5[] = {
	gsSPClearGeometryMode(G_LIGHTING),
	gsSPVertex(ashpile2_bits_Cylinder_003_mesh_layer_5_vtx_cull + 0, 8, 0),
	gsSPSetGeometryMode(G_LIGHTING),
	gsSPCullDisplayList(0, 7),
	gsSPDisplayList(mat_ashpile2_bits_Ash),
	gsSPDisplayList(ashpile2_bits_Cylinder_003_mesh_layer_5_tri_0),
	gsSPDisplayList(mat_revert_ashpile2_bits_Ash),
	gsSPEndDisplayList(),
};

Gfx ashpile2_bits_material_revert_render_settings[] = {
	gsDPPipeSync(),
	gsSPSetGeometryMode(G_LIGHTING),
