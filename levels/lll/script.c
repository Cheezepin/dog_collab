...
const LevelScript level_lll_entry[] = {
	...
	AREA(1, lll_area_1),
		...
		WARP_NODE(0x1E, LEVEL_LLL, 0x02, 0xF3, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_NONE, -1838, 2819, -3522, 0, -90, 0, 0x00000000, bhvCloud),
		OBJECT(MODEL_NONE, -1740, 2919, -1541, 0, -45, 0, 0x00000000, bhvCloud),
		OBJECT(MODEL_NONE, -540, 3419, -1441, 0, 0, 0, 0x00000000, bhvCloud),
		OBJECT(MODEL_NONE, 1284, 4121, -1577, 0, 40, 0, 0x00000000, bhvCloud),
		OBJECT(MODEL_NONE, -2238, 1722, -5522, 0, -145, 0, 0x00000000, bhvCloud),
		...
		OBJECT(MODEL_KOOPATROL, 1710, 0, 128, 0, 0, 0, 0x00000000, bhvKoopatrol),
		OBJECT(MODEL_KOOPATROL, -2800, 0, 2728, 0, 0, 0, 0x00000000, bhvKoopatrol),
		OBJECT(MODEL_KOOPATROL, -5068, 0, 2328, 0, 0, 0, 0x00000000, bhvKoopatrol),
		OBJECT(MODEL_KOOPATROL, 8065, 0, 1978, 0, 0, 0, 0x00000000, bhvKoopatrol),
		OBJECT(MODEL_KOOPATROL, 5232, 0, 2928, 0, 0, 0, 0x00000000, bhvKoopatrol),
		OBJECT(MODEL_KOOPATROL, 5632, 0, -1872, 0, 0, 0, 0x00000000, bhvKoopatrol),
		OBJECT(MODEL_KOOPATROL, 6932, 0, -672, 0, 0, 0, 0x00000000, bhvKoopatrol),
		...
		OBJECT(MODEL_MONTY_MOLE, -1368, 0, 28, 0, 0, 0, (1 << 16), bhvMontyMole),
	...
	AREA(2, lll_area_2),
		...
		OBJECT(MODEL_NONE, -6746, 891, -3853, 0, 90, 0, 0x00000000, bhvCloud),
		OBJECT(MODEL_REX, -5893, 1750, 700, 0, -90, 0, 0x00000000, bhvRex),
		OBJECT(MODEL_STAR, -11698, 3970, -1026, 0, -180, 0, (0x00 << 24), bhvStar),
		OBJECT(MODEL_NONE, 1107, 0, 0, 0, -90, 0, 0x00F30000, bhvAirborneWarp),
