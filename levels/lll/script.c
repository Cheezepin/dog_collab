...
const LevelScript level_lll_entry[] = {
	...
	AREA(3, lll_area_3),
		WARP_NODE(0x0A, LEVEL_LLL, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF0, LEVEL_LLL, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_LLL, 0x03, 0x1B, WARP_NO_CHECKPOINT),
		WARP_NODE(0x1B, LEVEL_LLL, 0x01, 0x1B, WARP_NO_CHECKPOINT),
		WARP_NODE(0x1C, LEVEL_LLL, 0x01, 0x1D, WARP_NO_CHECKPOINT),
		WARP_NODE(0x1E, LEVEL_LLL, 0x04, 0x1F, WARP_NO_CHECKPOINT),
		WARP_NODE(0x21, LEVEL_LLL, 0x04, 0x21, WARP_NO_CHECKPOINT),
	...
	AREA(4, lll_area_4),
		WARP_NODE(0x0A, LEVEL_LLL, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF0, LEVEL_LLL, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_LLL, 0x04, 0x1F, WARP_NO_CHECKPOINT),
		WARP_NODE(0x1F, LEVEL_LLL, 0x03, 0x1F, WARP_NO_CHECKPOINT),
