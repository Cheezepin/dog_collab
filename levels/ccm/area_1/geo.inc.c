...
const GeoLayout ccm_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 4381, 963, -8432),
		GEO_OPEN_NODE(),
			GEO_RENDER_RANGE(0, 4000),
			GEO_OPEN_NODE(),
				GEO_DISPLAY_LIST(1, ccm_dl_crystal_hi_003_mesh_layer_1),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 63, 897, 1978),
		GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			GEO_RENDER_RANGE(4000, 15000),
			GEO_OPEN_NODE(),
				GEO_DISPLAY_LIST(1, ccm_dl_crystal_lo_003_mesh_layer_1),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(1, -361, 318, 4586, ccm_dl_Cube_001_mesh_layer_1),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 718, 312, -3567),
		GEO_OPEN_NODE(),
			GEO_RENDER_RANGE(0, 5000),
			GEO_OPEN_NODE(),
				GEO_DISPLAY_LIST(1, ccm_dl_hi_castle_mesh_layer_1),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 2120, 312, -6078),
		GEO_OPEN_NODE(),
			GEO_RENDER_RANGE(0, 5000),
			GEO_OPEN_NODE(),
				GEO_DISPLAY_LIST(1, ccm_dl_hi_castle_001_mesh_layer_1),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 718, 312, -3567),
		GEO_OPEN_NODE(),
			GEO_RENDER_RANGE(5000, 15000),
			GEO_OPEN_NODE(),
				GEO_DISPLAY_LIST(1, ccm_dl_lo_castle_mesh_layer_1),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 2120, 312, -6078),
		GEO_OPEN_NODE(),
			GEO_RENDER_RANGE(5000, 15000),
			GEO_OPEN_NODE(),
				GEO_DISPLAY_LIST(1, ccm_dl_lo_castle_001_mesh_layer_1),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(1, 3011, 191, 7121, ccm_dl_sunken_castle_003_mesh_layer_1),
