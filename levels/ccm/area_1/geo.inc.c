...
const GeoLayout ccm_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 13109, 578, -2750, -4, 110, 0, ccm_dl_hi_castle_009_mesh_layer_1),
		GEO_TRANSLATE_ROTATE(LAYER_OPAQUE, 718, 312, -3567, 0, -12, 0),
		GEO_OPEN_NODE(),
			GEO_RENDER_RANGE(5000, 15000),
			GEO_OPEN_NODE(),
...
const GeoLayout ccm_area_1[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_ZBUFFER(1),
		GEO_OPEN_NODE(),
			GEO_CAMERA_FRUSTUM_WITH_FUNC(45.0000, 100, 32000, geo_camera_fov),
			GEO_OPEN_NODE(),
