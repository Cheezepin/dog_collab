...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		OBJECT(MODEL_BLUE_COIN, -2946, 1419, -5187, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, -4146, 1419, -6387, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		...
		OBJECT(MODEL_BLUE_COIN, -3546, 1436, -5787, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, -4722, 1436, -5787, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN_SWITCH, -672, 1304, -4827, 0, 0, 0, (4 << 16), bhvBlueCoinSwitch),
		...
		OBJECT(MODEL_YELLOW_COIN_NO_SHADOW, 1399, 11998, -9962, 0, 0, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_YELLOW_COIN_NO_SHADOW, 2829, 11998, -11392, 0, 0, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_YELLOW_COIN_NO_SHADOW, 1818, 11998, -10973, 0, 0, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_YELLOW_COIN_NO_SHADOW, 3840, 11998, -10973, 0, 0, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_YELLOW_COIN_NO_SHADOW, 4259, 11998, -9962, 0, 0, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_YELLOW_COIN_NO_SHADOW, 3840, 11998, -8951, 0, 0, 0, 0x00000000, bhvYellowCoin),
		OBJECT(MODEL_YELLOW_COIN_NO_SHADOW, 1818, 11998, -8951, 0, 0, 0, 0x00000000, bhvYellowCoin),
		...
		OBJECT(MODEL_LAVA_GRATE, -5817, 886, -5759, 0, 0, 0, 0x00000000, bhvLavaGrate),
		OBJECT(MODEL_LAVA_GRATE, -6708, 529, -5759, 0, 0, 0, 0x00000000, bhvLavaGrate),
		...
		OBJECT(MODEL_RED_COIN, -2310, 895, 3382, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, -5876, 3732, 6603, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, 2825, 1257, 7162, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, -409, 842, 4770, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, 4646, 1061, -7544, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, -4713, 1030, 5982, 0, 0, 0, 0x00000000, bhvRedCoin),
		...
		OBJECT_WITH_ACTS(MODEL_TOAD_CAGE, -7526, 874, -5669, 0, 0, 0, 0x00000000, bhvToadCage, ACT_5),
