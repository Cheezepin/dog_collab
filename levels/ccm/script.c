...
const LevelScript level_ccm_entry[] = {
	...
	AREA(1, ccm_area_1),
		...
		OBJECT(MODEL_ROVERT_ELEVATOR, 11449, 3247, 4447, 0, 0, 0, 0x00000000, bhvRovertElevator),
		...
		OBJECT(MODEL_TANK_BASE, 2829, 11997, -9962, 0, 0, 0, 0x05000000, bhvTankBase),
		...
		OBJECT(MODEL_TOAD, -918, 842, -384, 0, 0, 0, 0x04000000, bhvRovertToad),
