...
DEFINE_COURSE(COURSE_LLL, 0x20022240) // (7)  Lethal Lava Land (Yoshi Milkman, Sakura Stronghold)
DEFINE_COURSE(COURSE_SSL, 0x44444440) // (8)  Shifting Sand Land (Reonu, Floating Lava Lands)
DEFINE_COURSE(COURSE_DDD, 0x12211040) // (9)  Dire Dire Docks (thecozies, Bowser's Scuba Tower)
DEFINE_COURSE(COURSE_SL, 0x44444440) // (10) Snowman's Land (axollyon, Upside-Down Ocean)
DEFINE_COURSE(COURSE_WDW, 0x01002240) // (11) Wet Dry World (ashley, Mapel Markindon)
