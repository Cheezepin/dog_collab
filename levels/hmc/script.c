...
const LevelScript level_hmc_entry[] = {
	...
	AREA(2, hmc_area_2),
		...
		OBJECT(MODEL_RED_COIN, -3184, 4760, -1351, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_TRANSPARENT_STAR, -4315, 4208, -2658, 0, 0, 0, 0x00000000, bhvRedCoinStarMarker),
		OBJECT(MODEL_RED_COIN, -3459, 5246, -1363, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, -1725, 7145, -229, 0, 0, 0, 0x00000000, bhvRedCoin),
		...
		OBJECT(MODEL_RED_COIN, -3507, 6908, -3743, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_STAR, -4315, 4543, -2658, 0, 0, 0, 0x02000000, bhvHiddenRedCoinStar),
