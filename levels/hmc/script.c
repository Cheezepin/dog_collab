...
const LevelScript level_hmc_entry[] = {
	...
	AREA(2, hmc_area_2),
		...
		OBJECT_WITH_ACTS(MODEL_HMCELEVATOR, 908, 4219, 26, 0, 0, 0, 0x00000000, bhvHMCElevator, ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
		OBJECT_WITH_ACTS(MODEL_HMCELEVATOR, 908, 8000, 26, 0, 0, 0, 0x00010000, bhvHMCElevator, ACT_1),
		...
		OBJECT(MODEL_KOOPA_NPC, 1056, 4215, -1583, 0, 0, 0, 0x009A0000, bhvKoopaDialog),
		...
		OBJECT(MODEL_NONE, 908, 8255, 0, 0, -180, 0, 0x000B0000, bhvInstantActiveWarp),
