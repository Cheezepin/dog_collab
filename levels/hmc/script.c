...
const LevelScript level_hmc_entry[] = {
	...
	AREA(2, hmc_area_2),
		...
		OBJECT(MODEL_KOOPA_NPC, 2623, 4215, -551, 0, 0, 0, 0x00A10000, bhvKoopaDialog),
		...
		OBJECT(MODEL_REDBLOCK, 2379, 4215, -891, 0, 0, 0, 0x00000000, bhvStarBlock),
		OBJECT_WITH_ACTS(MODEL_REDBLOCK, 5706, 5737, -9562, 0, 0, 0, 0x00000000, bhvStarBlock, ACT_2 | ACT_3 | ACT_4 | ACT_5 | ACT_6),
