...
const LevelScript level_castle_grounds_entry[] = {
	...
	AREA(1, castle_grounds_area_1),
		...
		WARP_NODE(0x0E, LEVEL_BOWSER_3, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_CHEEZE_LIGHTNING, -3277, 3080, -1874, -35, -117, 0, 0x00000000, bhvCheezeLightning),
		OBJECT(MODEL_CHEEZE_LIGHTNING, -3610, 2875, -1619, -35, -117, 0, (27 << 16), bhvCheezeLightning),
		OBJECT(MODEL_CHEEZE_LIGHTNING, 3483, 3296, 306, -35, 85, 0, (1), bhvCheezeLightning),
