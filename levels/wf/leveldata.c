...
#include "levels/wf/jetski/anims/data.inc.c"
#include "levels/wf/jetski/anims/table.inc.c"
#include "levels/wf/koko/model.inc.c"
#include "levels/wf/atoll_ocean/model.inc.c"
