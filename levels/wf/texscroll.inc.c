void scroll_sts_mat_wf_dl_scrolling_lava_layer1() {
	Gfx *mat = segmented_to_virtual(mat_wf_dl_scrolling_lava_layer1);
	shift_t(mat, 20, PACK_TILESIZE(0, 3));
...
void scroll_wf() {
	scroll_sts_mat_wf_dl_scrolling_lava_layer1();
