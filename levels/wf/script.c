...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_NONE, -18191, 1273, 7, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, -18191, 1273, 7),
		OBJECT(MODEL_EXCLAMATION_BOX, -13506, 1324, -982, 0, 0, 0, (3 << 16), bhvExclamationBox),
		OBJECT(MODEL_EXCLAMATION_BOX, 6181, 1334, 9694, 0, 0, 0, (3 << 16), bhvExclamationBox),
		OBJECT(MODEL_EXCLAMATION_BOX, 9778, 1346, -17073, 0, 0, 0, (3 << 16), bhvExclamationBox),
		OBJECT(MODEL_WF_PALM_TREE, -19248, 1004, -4046, 0, 0, 0, 0x00000000, bhvPalmTree),
		OBJECT(MODEL_WF_PALM_TREE, -17859, 1004, -2840, 0, 0, 0, 0x00000000, bhvPalmTree),
		OBJECT(MODEL_WF_PALM_TREE, -18749, 1004, 3622, 0, 0, 0, 0x00000000, bhvPalmTree),
		OBJECT(MODEL_WF_PALM_TREE, -18670, 1004, 2289, 0, 0, 0, 0x00000000, bhvPalmTree),
		OBJECT(MODEL_WF_PALM_TREE, -17066, 1004, 2263, 0, 0, 0, 0x00000000, bhvPalmTree),
		OBJECT(MODEL_WF_PALM_TREE, 13543, 923, 17328, 0, 0, 0, 0x00000000, bhvPalmTree),
		OBJECT(MODEL_WF_PALM_TREE, 1906, 947, -14967, 0, 0, 0, 0x00000000, bhvPalmTree),
		OBJECT(MODEL_WF_PALM_TREE, 7511, 947, -9228, 0, 0, 0, 0x00000000, bhvPalmTree),
		OBJECT(MODEL_WF_PALM_TREE, 2650, 947, -12859, 0, 0, 0, 0x00000000, bhvPalmTree),
		OBJECT(MODEL_WF_PALM_TREE, 4485, 947, -10467, 0, 0, 0, 0x00000000, bhvPalmTree),
