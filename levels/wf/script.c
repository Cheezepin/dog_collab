...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_SANDPILE, -4441, 787, 7891, 0, 0, 0, (8 << 8), bhvSandPile),
		OBJECT(MODEL_SANDPILE, -4943, 787, 7589, 0, 0, 0, (15 << 8), bhvSandPile),
		OBJECT(MODEL_SANDPILE, -4887, 787, 6946, 0, 0, 0, (20 << 8), bhvSandPile),
		OBJECT(MODEL_SANDPILE, -5292, 787, 6228, 0, 0, 0, (25 << 8), bhvSandPile),
