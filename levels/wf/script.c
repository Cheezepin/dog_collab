...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_NONE, -262, -344, -195, 0, 21, 0, (4 << 24), bhvHiddenRedCoinStar),
		...
		OBJECT(MODEL_KOOPA_WITH_SHELL, -6746, 1006, 373, 0, 10, 0, (KOOPA_BP_KOOPA_THE_QUICK_BOB << 16), bhvKoopa),
