...
const LevelScript level_wf_entry[] = {
	...
	AREA(1, wf_area_1),
		...
		OBJECT(MODEL_NONE, -5132, 1404, 907, 180, 0, 90, 0x000A0000, bhvSpinAirborneWarp),
		MARIO_POS(0x01, 0, -5132, 1404, 907),
		OBJECT(MODEL_NONE, 6210, 3092, -5989, 0, 0, 0, (100 << 24) | (0x0D << 16), bhvWarp),
		...
		OBJECT(MODEL_NONE, 4563, 1355, 5968, 0, 86, 0, (COIN_FORMATION_BP_SHAPE_HORIZONTAL_RING << 16), bhvCoinFormation),
		...
		OBJECT(MODEL_WF_CRATE, -6342, 845, -853, 0, 10, 0, (BREAKABLE_BOX_BP_3_COINS << 16), bhvBreakableBox),
		OBJECT(MODEL_WF_CRATE, -6222, 845, -788, 0, -25, 0, (BREAKABLE_BOX_BP_3_COINS << 16), bhvBreakableBox),
		OBJECT(MODEL_WF_CRATE, -6342, 845, -853, 0, 10, 0, (BREAKABLE_BOX_BP_3_COINS << 16), bhvBreakableBox),
		...
		OBJECT(MODEL_WF_CRATE, 3165, 1061, 7489, 0, -17, 0, (BREAKABLE_BOX_BP_3_COINS << 16), bhvBreakableBox),
		...
		OBJECT(MODEL_PURPLE_SWITCH, 4548, 1355, 5950, 0, 53, 0, 0x00000000, bhvFloorSwitchHiddenObjects),
		...
		OBJECT(MODEL_EXCLAMATION_BOX, 4269, 1759, 6545, 0, 0, 0, (EXCLAMATION_BOX_BP_JETSKI << 16), bhvExclamationBox),
		...
		OBJECT(MODEL_WF_PALM_TREE, -6744, 846, -855, 0, 0, 0, 0x00000000, bhvPalmTree),
		OBJECT(MODEL_WF_PALM_TREE, -7149, 846, -57, 0, 0, 0, 0x00000000, bhvPalmTree),
		OBJECT(MODEL_WF_PALM_TREE, -6877, 846, 2627, 0, 0, 0, 0x00000000, bhvPalmTree),
		OBJECT(MODEL_WF_PALM_TREE, -6195, 846, 2876, 0, 0, 0, 0x00000000, bhvPalmTree),
		...
		OBJECT(MODEL_KOOPA_WITH_SHELL, -6730, 976, 773, 0, 10, 0, (1 << 24) | (KOOPA_BP_KOOPA_THE_QUICK_BOB << 16), bhvKoopa),
	...
	AREA(2, wf_area_2),
		...
		OBJECT(MODEL_BULLY_BOSS, 590, -3186, 0, 0, 0, 0, 0x020D0000, bhvBigBully),
		OBJECT(MODEL_EXCLAMATION_BOX, -5563, -5310, 0, 0, 0, 0, (EXCLAMATION_BOX_BP_JETSKI << 16), bhvExclamationBox),
		OBJECT(MODEL_NONE, -5646, -4326, -6, 0, 0, 0, 0x000D0000, bhvSpinAirborneWarp),
