...
const GeoLayout wf_dl_B__Overworld__geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_ALPHA, -6533, 850, 621, wf_dl_Koopa_Hut__Visual__mesh_layer_4),
		GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_OPEN_NODE(),
					...
					GEO_CLOSE_NODE(),
				GEO_CLOSE_NODE(),
				GEO_TRANSLATE_NODE(LAYER_OPAQUE, -18297, 1000, -3613),
				GEO_OPEN_NODE(),
					GEO_RENDER_RANGE(0, 25000),
					GEO_OPEN_NODE(),
				...
				GEO_OPEN_NODE(),
					...
					GEO_CLOSE_NODE(),
				GEO_CLOSE_NODE(),
				GEO_TRANSLATE_NODE(LAYER_OPAQUE, -17182, 1000, 3113),
				GEO_OPEN_NODE(),
					GEO_RENDER_RANGE(0, 25000),
					GEO_OPEN_NODE(),
...
const GeoLayout wf_dl_C__Hut_Interior__geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_ALPHA, -11422, 975, -1894, 90, 0, 102, wf_dl_Hammock_mesh_layer_4),
			GEO_OPEN_NODE(),
				GEO_DISPLAY_LIST(LAYER_OPAQUE, wf_dl_Hammock_mesh_layer_1),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, -11533, 850, -1579, wf_dl_Hut_Interior__Visual__mesh_layer_5),
			GEO_OPEN_NODE(),
