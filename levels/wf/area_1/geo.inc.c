...
const GeoLayout wf_dl_B__Overworld__geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_DISPLAY_LIST(LAYER_ALPHA, wf_dl_Dock_1__Visual__mesh_layer_4),
		...
		GEO_DISPLAY_LIST(LAYER_ALPHA, wf_dl_Koopa_Hut__Visual__mesh_layer_4),
		...
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT_INTER, wf_dl_ocean_mesh_layer_7),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, wf_dl_Rock_Hill_mesh_layer_1),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, -7124, 844, -923),
		GEO_OPEN_NODE(),
			...
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, -6649, 844, -707),
		GEO_OPEN_NODE(),
			GEO_RENDER_RANGE(0, 5000),
			GEO_OPEN_NODE(),
			...
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, -6874, 844, 2911),
		GEO_OPEN_NODE(),
			GEO_RENDER_RANGE(0, 5000),
			GEO_OPEN_NODE(),
			...
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, -6091, 844, 2656),
		GEO_OPEN_NODE(),
			GEO_RENDER_RANGE(0, 5000),
			GEO_OPEN_NODE(),
			...
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 9272, 804, 9764),
		GEO_OPEN_NODE(),
			GEO_RENDER_RANGE(0, 5000),
			GEO_OPEN_NODE(),
			...
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 3453, 815, -6383),
		GEO_OPEN_NODE(),
			GEO_RENDER_RANGE(0, 5000),
			GEO_OPEN_NODE(),
			...
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 6255, 815, -3514),
		GEO_OPEN_NODE(),
			GEO_RENDER_RANGE(0, 5000),
			GEO_OPEN_NODE(),
			...
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 3825, 815, -5329),
		GEO_OPEN_NODE(),
			GEO_RENDER_RANGE(0, 5000),
			GEO_OPEN_NODE(),
			...
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 4743, 815, -4133),
		GEO_OPEN_NODE(),
			GEO_RENDER_RANGE(0, 5000),
			GEO_OPEN_NODE(),
			...
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_ROTATE(LAYER_OPAQUE, -5703, 784, 4935, 0, 19, 0),
		GEO_OPEN_NODE(),
			...
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, wf_dl_Volcano__mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_ALPHA, wf_dl_Volcano__mesh_layer_4),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT_INTER, wf_dl_water_mesh_layer_7),
...
const GeoLayout wf_dl_C__Hut_Interior__geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_ALPHA, wf_dl_Hammock_mesh_layer_4),
			GEO_DISPLAY_LIST(LAYER_OPAQUE, wf_dl_Hammock_mesh_layer_1),
			GEO_DISPLAY_LIST(LAYER_TRANSPARENT, wf_dl_Hut_Interior__Visual__mesh_layer_5),
