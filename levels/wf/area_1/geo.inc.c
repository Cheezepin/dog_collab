...
const GeoLayout wf_dl_B__Overworld__geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_ALPHA, 0, 688, 0, wf_dl_Bounds_Barrier__Visual__mesh_layer_4),
		GEO_RENDER_RANGE(0, 11500),
		GEO_OPEN_NODE(),
		...
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_ALPHA, -6426, 847, 1040, wf_dl_Koopa_Hut__Visual__mesh_layer_4),
		GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, 0, 688, 0, wf_dl_Ocean__Background__mesh_layer_5),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				GEO_TRANSLATE_NODE(LAYER_OPAQUE, -18488, 1000, -3909),
				GEO_OPEN_NODE(),
					...
					GEO_CLOSE_NODE(),
				GEO_CLOSE_NODE(),
				GEO_TRANSLATE_NODE(LAYER_OPAQUE, -19299, 1000, -2315),
				GEO_OPEN_NODE(),
					GEO_RENDER_RANGE(0, 25000),
					GEO_OPEN_NODE(),
					...
					GEO_CLOSE_NODE(),
				GEO_CLOSE_NODE(),
				GEO_TRANSLATE_NODE(LAYER_OPAQUE, -18754, 1000, 3055),
				GEO_OPEN_NODE(),
					GEO_RENDER_RANGE(0, 25000),
					GEO_OPEN_NODE(),
					...
					GEO_CLOSE_NODE(),
				GEO_CLOSE_NODE(),
				GEO_TRANSLATE_NODE(LAYER_OPAQUE, -17391, 1000, 3551),
				GEO_OPEN_NODE(),
					GEO_RENDER_RANGE(0, 25000),
					GEO_OPEN_NODE(),
			...
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 6059, 2012, -6003, wf_dl_Volcano__Visual__mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT_INTER, 0, 688, 0, wf_dl_Water__Visual__mesh_layer_7),
		GEO_ASM(0, geo_backdrop_move),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_FORCE, 0, 1376, 0, atoll_skybox_backdrop_mesh),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
const GeoLayout wf_dl_C__Hut_Interior__geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_ALPHA, -11312, 976, -1482, 90, 0, 102, wf_dl_Hammock_mesh_layer_4),
			GEO_OPEN_NODE(),
				GEO_DISPLAY_LIST(LAYER_OPAQUE, wf_dl_Hammock_mesh_layer_1),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, -11428, 854, -1155, wf_dl_Hut_Interior__Visual__mesh_layer_5),
			GEO_OPEN_NODE(),
