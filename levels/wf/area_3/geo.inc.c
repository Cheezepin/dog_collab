...
const GeoLayout wf_area_3_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT_INTER, 0, 1, 0, wf_dl_Bottled_Water_mesh_layer_7),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, 0, 6, 0, wf_dl_Glass_Bottle_mesh_layer_5),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 0, 6, 0, wf_dl_Ship_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
