Lights1 floor_door_Metal_001_lights = gdSPDefLights1(
	0x7F, 0x7F, 0x7F,
	0xFE, 0xFE, 0xFE, 0x28, 0x28, 0x28);

Gfx floor_door_i8_metal_pattern2_i8_aligner[] = {gsSPEndDisplayList()};
u8 floor_door_i8_metal_pattern2_i8[] = {
...
Vtx floor_door_FloorDoor_mesh_layer_1_vtx_cull[8] = {
	{{{-198, 0, 228},0, {-16, -16},{0x0, 0x0, 0x0, 0x0}}},
	{{{-198, 0, 228},0, {-16, -16},{0x0, 0x0, 0x0, 0x0}}},
	{{{-198, 0, -228},0, {-16, -16},{0x0, 0x0, 0x0, 0x0}}},
	{{{-198, 0, -228},0, {-16, -16},{0x0, 0x0, 0x0, 0x0}}},
	{{{198, 0, 228},0, {-16, -16},{0x0, 0x0, 0x0, 0x0}}},
...
Vtx floor_door_FloorDoor_mesh_layer_1_vtx_0[6] = {
	{{{198, 0, 114},0, {2180, 1685},{0xFF, 0xFF, 0xFF, 0xFF}}},
	{{{198, 0, -114},0, {2180, 331},{0xFF, 0xFF, 0xFF, 0xFF}}},
	{{{0, 0, -228},0, {1008, -346},{0xFF, 0xFF, 0xFF, 0xFF}}},
	{{{-198, 0, 114},0, {-164, 1685},{0xFF, 0xFF, 0xFF, 0xFF}}},
	{{{-198, 0, -114},0, {-164, 331},{0xFF, 0xFF, 0xFF, 0xFF}}},
	{{{0, 0, 228},0, {1008, 2362},{0xFF, 0xFF, 0xFF, 0xFF}}},
};
...
Gfx mat_floor_door_Metal_001[] = {
	gsDPPipeSync(),
	gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, ENVIRONMENT, TEXEL0, 0, SHADE, 0, 0, 0, 0, ENVIRONMENT),
	gsSPClearGeometryMode(G_LIGHTING),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsDPTileSync(),
	gsDPSetTextureImage(G_IM_FMT_I, G_IM_SIZ_8b_LOAD_BLOCK, 1, floor_door_i8_metal_pattern2_i8),
	...
	gsSPSetLights1(floor_door_Metal_001_lights),
	gsSPEndDisplayList(),
};

Gfx mat_revert_floor_door_Metal_001[] = {
	gsDPPipeSync(),
...
Gfx floor_door_material_revert_render_settings[] = {
	gsDPPipeSync(),
	gsSPSetGeometryMode(G_LIGHTING),
