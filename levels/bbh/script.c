...
const LevelScript level_bbh_entry[] = {
	...
	AREA(1, bbh_area_1),
		...
		OBJECT(MODEL_NONE, 4454, -428, 13462, 0, 0, 0, 0x01000000, bhvHiddenStar),
	...
	AREA(2, bbh_area_2),
		...
		OBJECT(MODEL_GOOMBA, 12243, 8125, -14281, 0, -180, 0, 0x00000000, bhvFwooshMGGoomba),
		OBJECT(MODEL_GOOMBA, 11840, 8125, -14032, 0, -180, 0, 0x00000000, bhvFwooshMGGoomba),
		OBJECT(MODEL_GOOMBA, 12261, 8125, -13617, 0, -180, 0, 0x00000000, bhvFwooshMGGoomba),
		OBJECT(MODEL_GOOMBA, 11931, 8125, -13350, 0, -180, 0, 0x00000000, bhvFwooshMGGoomba),
		OBJECT(MODEL_GOOMBA, 12747, 8125, -14105, 0, -180, 0, 0x00000000, bhvFwooshMGGoomba),
		OBJECT(MODEL_KOOPA_WITH_SHELL, 11329, 8125, -14545, 0, -180, 0, 0x00000000, bhvFwooshMGKoopa),
		OBJECT(MODEL_KOOPA_WITH_SHELL, 11291, 8125, -13917, 0, -180, 0, 0x00000000, bhvFwooshMGKoopa),
		OBJECT(MODEL_KOOPA_WITH_SHELL, 11601, 8125, -13348, 0, -180, 0, 0x00000000, bhvFwooshMGKoopa),
		OBJECT(MODEL_GOOMBA, 11840, 8125, -14593, 0, -180, 0, 0x00010000, bhvFwooshMGGoomba),
		OBJECT(MODEL_GOOMBA, 11856, 8125, -13689, 0, -180, 0, 0x00010000, bhvFwooshMGGoomba),
