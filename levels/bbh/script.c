...
const LevelScript level_bbh_entry[] = {
	...
	AREA(1, bbh_area_1),
		OBJECT(MODEL_NONE, -10897, 176, 14867, 0, 130, 0, 0x000B0000, bhvAirborneDeathWarp),
		MARIO_POS(0x01, 130, -10897, 176, 14867),
		OBJECT(MODEL_NONE, -10897, 176, 14867, 0, 130, 0, 0x000A0000, bhvFlyingWarp),
