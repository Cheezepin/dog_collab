...
const LevelScript level_bbh_entry[] = {
	...
	AREA(1, bbh_area_1),
		...
		OBJECT(MODEL_BOUNCE_CLOUD, -12442, 1267, 518, 0, 0, 0, 0x00000000, bhvBounceCloud),
		OBJECT(MODEL_BOUNCE_CLOUD, -11507, 1267, -1008, 0, 0, 0, 0x00000000, bhvBounceCloud),
		OBJECT(MODEL_BOUNCE_CLOUD, -7030, 1513, -6244, 0, 0, 0, 0x00000000, bhvBounceCloud),
		...
		OBJECT(MODEL_STRETCH_CLOUD, -5364, 1513, -7633, 0, 45, 0, 0x00000000, bhvStretchCloud),
		OBJECT(MODEL_STRETCH_CLOUD, -8398, 1513, -4967, 0, 46, 0, 0x00000000, bhvStretchCloud),
