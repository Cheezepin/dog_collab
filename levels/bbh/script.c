...
const LevelScript level_bbh_entry[] = {
	...
	AREA(1, bbh_area_1),
		...
		OBJECT(MODEL_BOUNCE_CLOUD, -3910, 169, 12345, 0, 0, 0, 0x00000000, bhvBounceCloud),
		OBJECT(MODEL_BOUNCE_CLOUD, -4767, 169, 11231, 0, 0, 0, 0x00000000, bhvBounceCloud),
		...
		OBJECT(MODEL_STRETCH_CLOUD, -6841, 169, 13708, 0, 0, 0, 0x00000000, bhvStretchCloud),
		OBJECT(MODEL_STRETCH_CLOUD, -4406, 169, 15672, 0, 90, 0, 0x00000000, bhvStretchCloud),
