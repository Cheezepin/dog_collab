...
const LevelScript level_bbh_entry[] = {
	...
	AREA(1, bbh_area_1),
		...
		OBJECT(MODEL_NONE, 10948, -597, 15088, 0, 78, 0, 0x000B0000, bhvAirborneDeathWarp),
		MARIO_POS(0x01, 78, 10948, -597, 15088),
		OBJECT(MODEL_NONE, 10948, -597, 15088, 0, 78, 0, 0x000A0000, bhvFlyingWarp),
