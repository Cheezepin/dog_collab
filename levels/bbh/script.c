...
const LevelScript level_bbh_entry[] = {
	...
	AREA(1, bbh_area_1),
		...
		OBJECT(MODEL_NONE, -16402, 176, 15365, 0, 110, 0, 0x000B0000, bhvAirborneDeathWarp),
		MARIO_POS(0x01, 110, -16402, 176, 15365),
		OBJECT(MODEL_NONE, -16402, 176, 15365, 0, 110, 0, 0x000A0000, bhvFlyingWarp),
		...
		OBJECT(MODEL_MIST_SECRET, 3245, -591, 9739, 0, 0, 0, 0x00000000, bhvHiddenStarTrigger),
		OBJECT(MODEL_MIST_SECRET, 3344, -591, 11024, 0, 0, 0, 0x00000000, bhvHiddenStarTrigger),
		OBJECT(MODEL_MIST_SECRET, 3850, -591, 11307, 0, 0, 0, 0x00000000, bhvHiddenStarTrigger),
		OBJECT(MODEL_MIST_SECRET, 4692, -591, 11056, 0, 0, 0, 0x00000000, bhvHiddenStarTrigger),
		OBJECT(MODEL_MIST_SECRET, 4348, -591, 9780, 0, 0, 0, 0x00000000, bhvHiddenStarTrigger),
		...
		OBJECT(MODEL_NONE, 4144, -391, 10447, 0, 0, 0, 0x02000000, bhvHiddenStar),
