...
const LevelScript level_bbh_entry[] = {
	...
	AREA(1, bbh_area_1),
		...
		OBJECT(MODEL_NONE, -4878, 3047, 11603, 0, 92, 0, 0x000B0000, bhvAirborneDeathWarp),
		MARIO_POS(0x01, 92, -4878, 3047, 11603),
		OBJECT(MODEL_NONE, -4878, 3047, 11603, 0, 92, 0, 0x000A0000, bhvFlyingWarp),
		OBJECT(MODEL_BLUE_COIN, -3348, 3783, 12563, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, -3871, 3596, 11841, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, -4891, 4254, 13396, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, -4323, 4385, 12563, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN, -2372, 4571, 12563, 0, 0, 0, 0x00000000, bhvHiddenBlueCoin),
		OBJECT(MODEL_BLUE_COIN_SWITCH, -3461, 3858, 13535, 0, 13, 0, 0x00020000, bhvBlueCoinSwitch),
		...
		OBJECT(MODEL_BOUNCE_CLOUD, -3179, 215, 4869, 0, 73, 0, 0x00000000, bhvBounceCloud),
		OBJECT(MODEL_BOUNCE_CLOUD, -1803, 815, 4191, 0, 73, 0, 0x00000000, bhvBounceCloud),
		OBJECT(MODEL_BOUNCE_CLOUD, -3265, 1415, 3897, 0, 73, 0, 0x00000000, bhvBounceCloud),
		...
		OBJECT(MODEL_MIST_SECRET, 9900, 492, 9315, 0, 0, 0, 0x00000000, bhvHiddenStarTrigger),
		...
		OBJECT(MODEL_MIST_SECRET, 3505, -528, 6737, 0, 0, 0, 0x00000000, bhvHiddenStarTrigger),
		...
		OBJECT(MODEL_NONE, 4235, -428, 13682, 0, 0, 0, 0x01000000, bhvHiddenStar),
		...
		OBJECT(MODEL_STRETCH_CLOUD, 3505, -728, 8596, 0, 90, 0, 0x00000000, bhvStretchCloud),
		OBJECT(MODEL_STRETCH_CLOUD, 5178, -728, 8596, 0, 90, 0, 0x00000000, bhvStretchCloud),
		OBJECT(MODEL_STRETCH_CLOUD, 1794, -728, 8596, 0, 90, 0, 0x00000000, bhvStretchCloud),
