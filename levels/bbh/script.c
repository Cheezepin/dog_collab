...
const LevelScript level_bbh_entry[] = {
	...
	AREA(1, bbh_area_1),
		...
		OBJECT_WITH_ACTS(MODEL_DOG, -8688, 9, 7214, 0, 0, 0, 0x00000000, bhvComitDog, ACT_2),
		OBJECT_WITH_ACTS(MODEL_DOG, 2360, -728, 11577, 0, 0, 0, 0x01000000, bhvComitDog, ACT_3),
		OBJECT_WITH_ACTS(MODEL_DOG, 7516, 50, 7401, 0, 0, 0, 0x02000000, bhvComitDog, ACT_4),
		OBJECT_WITH_ACTS(MODEL_DOG, 3171, 1480, 6481, 0, 0, 0, 0x03000000, bhvComitDog, ACT_6),
