...
const LevelScript level_bbh_entry[] = {
	...
	AREA(2, bbh_area_2),
		...
		OBJECT(MODEL_FWOOSH_BUTTON, 12899, 8125, -11952, 0, 0, 0, 0x00000000, bhvFwooshButton),
		OBJECT(MODEL_FWOOSH_BUTTON, 13686, 8125, -11952, 0, 0, 0, 0x00000000, bhvFwooshButton),
		OBJECT(MODEL_FWOOSH_BUTTON, 14472, 8125, -11952, 0, 0, 0, 0x00000000, bhvFwooshButton),
		OBJECT(MODEL_NONE, 12653, 8125, -14110, 0, -180, 0, 0x00000000, bhvGoombaTripletSpawner),
		OBJECT(MODEL_NONE, 13896, 8125, -14346, 0, -180, 0, 0x00000000, bhvGoombaTripletSpawner),
		OBJECT(MODEL_NONE, 14981, 8125, -13662, 0, -180, 0, 0x00000000, bhvGoombaTripletSpawner),
