...
const LevelScript level_bbh_entry[] = {
	...
	AREA(1, bbh_area_1),
		...
		OBJECT(MODEL_RAIN_CLOUD, -12252, 1418, -7372, 0, 0, 0, 0x00000000, bhvCRainCloud),
		OBJECT(MODEL_RAIN_CLOUD, 7399, -750, 9560, 0, -53, 0, 0x00000000, bhvCRainCloud),
		OBJECT(MODEL_RAIN_CLOUD, 9633, -705, 17651, 0, 115, 0, 0x00000000, bhvCRainCloud),
	...
	AREA(2, bbh_area_2),
		...
		OBJECT(MODEL_RAIN_CLOUD, 8794, 114, 6000, 0, -125, 0, 0x00000000, bhvCRainCloud),
