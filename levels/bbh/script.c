...
const LevelScript level_bbh_entry[] = {
	...
	AREA(1, bbh_area_1),
		WARP_NODE(0xF0, LEVEL_BBH, 0x01, 0xA, WARP_NO_CHECKPOINT),
		...
		WARP_NODE(0xF2, LEVEL_BBH, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_NONE, 14757, 2426, -9302, 0, 107, 0, (COIN_FORMATION_BP_SHAPE_VERTICAL_RING << 16), bhvCoinFormation),
		...
		OBJECT(MODEL_RAINBOW_CLOUD, 9861, 140, 5607, 0, 177, 0, 0x00000000, bhvRainbowCloud),
		...
		OBJECT(MODEL_STAR, 4877, 3678, 13910, 0, 45, 0, 0x03000000, bhvStar),
	...
	AREA(2, bbh_area_2),
		...
		OBJECT(MODEL_NONE, -12259, -505, 3936, 0, 90, 0, 0x000B0000, bhvSpinAirborneWarp),
		OBJECT_WITH_ACTS(MODEL_NONE, -10019, -603, 4399, 0, 152, 0, 0x00040000, bhvCoinFormation, ACT_5),
		OBJECT(MODEL_CASTLE_GROUNDS_CASTLE_DOOR, -12639, -705, 3969, 0, -90, 0, 0x000A0000, bhvDoorWarp),
		OBJECT_WITH_ACTS(MODEL_CASTLE_GROUNDS_CASTLE_DOOR, -5482, 124, -7596, 0, -180, 0, 0x004A0000, bhvDoorWarp, ACT_5),
		OBJECT_WITH_ACTS(MODEL_CASTLE_GROUNDS_CASTLE_DOOR, -5482, 124, -7596, 0, -180, 0, 0x004F0000, bhvDoorWarp, ACT_1 | ACT_2 | ACT_3 | ACT_4 | ACT_6),
		...
		SET_BACKGROUND_MUSIC(0x00, SEQ_COMIT_FACILITY),
	...
	AREA(3, bbh_area_3),
		...
		WARP_NODE(0x0B, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, 6769, -32, 6552, 0, -95, 0, 0x000B0000, bhvSpinAirborneWarp),
	...
	AREA(4, bbh_area_4),
		WARP_NODE(0xF0, LEVEL_BBH, 0x01, 0xA, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, LEVEL_BBH, 0x04, 0x0B, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0A, LEVEL_BBH, 0x02, 0x4F, WARP_NO_CHECKPOINT),
		WARP_NODE(0x0B, LEVEL_BOB, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, 6794, -32, 6613, 0, -95, 0, 0x000B0000, bhvSpinAirborneWarp),
