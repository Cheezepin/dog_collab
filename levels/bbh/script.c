...
const LevelScript level_bbh_entry[] = {
	...
	AREA(1, bbh_area_1),
		...
		OBJECT(MODEL_NONE, 2209, -728, 16481, 0, 73, 0, 0x00000000, bhvHiddenBounceCloud),
		...
		OBJECT(MODEL_RAIN_CLOUD, 9633, -705, 17651, 0, 115, 0, 0x00000000, bhvRainCloud),
		OBJECT(MODEL_STAR, 16672, 4060, -17471, 0, 0, 0, 0x00000000, bhvStar),
		OBJECT(MODEL_STAR, 4877, 3677, 13910, 0, 45, 0, 0x03000000, bhvStar),
		OBJECT(MODEL_NONE, 2021, -446, 21741, 0, 0, 0, 0x01000000, bhvStar),
		...
		OBJECT(MODEL_STRETCH_CLOUD, 5187, -831, 13678, 0, 37, 0, 0x00000000, bhvStretchCloud),
		OBJECT(MODEL_STRETCH_CLOUD, 4442, -831, 14240, 0, 37, 0, 0x00000000, bhvStretchCloud),
	...
	AREA(2, bbh_area_2),
		...
		OBJECT(MODEL_RAIN_CLOUD, 8794, 114, 6000, 0, -125, 0, 0x00000000, bhvRainCloud),
