...
const LevelScript level_bbh_entry[] = {
	...
	AREA(1, bbh_area_1),
		...
		OBJECT(MODEL_BOUNCE_CLOUD, 7637, 120, 5315, 0, 73, 0, 0x00000000, bhvBounceCloud),
		OBJECT(MODEL_BOUNCE_CLOUD, 6804, 720, 5807, 0, 73, 0, 0x00000000, bhvBounceCloud),
		OBJECT(MODEL_BOUNCE_CLOUD, 6320, 1220, 6542, 0, 73, 0, 0x00000000, bhvBounceCloud),
		OBJECT(MODEL_EXCLAMATION_BOX, 14667, -405, 12709, 0, 0, 0, 0x00060000, bhvExclamationBox),
		OBJECT(MODEL_EXCLAMATION_BOX, 5131, 2236, 1808, 0, 0, 0, 0x00060000, bhvExclamationBox),
		...
		OBJECT(MODEL_NONE, -1209, 2818, 8035, 0, 0, 0, 0x00120000, bhvCoinFormation),
