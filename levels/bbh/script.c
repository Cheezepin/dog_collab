...
const LevelScript level_bbh_entry[] = {
	...
	AREA(1, bbh_area_1),
		...
		OBJECT(MODEL_NONE, -9853, 200, 9198, 0, 92, 0, 0x000B0000, bhvAirborneDeathWarp),
		MARIO_POS(0x01, 92, -9853, 200, 9198),
		OBJECT(MODEL_NONE, -9853, 200, 9198, 0, 92, 0, 0x000A0000, bhvFlyingWarp),
		...
		OBJECT(MODEL_BOUNCE_CLOUD, 1165, 1794, 8623, 0, 73, 0, 0x00000000, bhvBounceCloud),
		OBJECT(MODEL_BOUNCE_CLOUD, 78, 2106, 7952, 0, 73, 0, 0x00000000, bhvBounceCloud),
		...
		OBJECT(MODEL_MIST_SECRET, 9399, 100, 9106, 0, 0, 0, 0x00000000, bhvHiddenStarTrigger),
		...
		OBJECT(MODEL_MIST_SECRET, -5606, 2709, 13240, 0, 0, 0, 0x00000000, bhvHiddenStarTrigger),
