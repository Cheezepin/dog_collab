...
const LevelScript level_bbh_entry[] = {
	...
	AREA(1, bbh_area_1),
		...
		OBJECT(MODEL_NONE, -15637, 395, 9607, 0, 168, 0, 0x000B0000, bhvAirborneDeathWarp),
		MARIO_POS(0x01, 168, -15637, 395, 9607),
		OBJECT(MODEL_NONE, -15637, 395, 9607, 0, 168, 0, 0x000A0000, bhvFlyingWarp),
		...
		OBJECT(MODEL_BOUNCE_CLOUD, 2758, -728, 18987, 0, 73, 0, 0x00000000, bhvBounceCloud),
		OBJECT(MODEL_BOUNCE_CLOUD, 1961, 2710, -14086, 0, -77, 0, 0x00000000, bhvBounceCloud),
		OBJECT(MODEL_NONE, 2709, -728, 16681, 0, 73, 0, 0x00000000, bhvHiddenBounceCloud),
		...
		OBJECT(MODEL_NONE, -6893, 2803, -14741, 0, 0, 0, 0x00120000, bhvCoinFormation),
		...
		OBJECT(MODEL_NONE, 16737, 3818, -17415, 0, 0, 0, 0x00120000, bhvCoinFormation),
		...
		OBJECT(MODEL_NONE, 2521, -446, 21941, 0, 0, 0, 0x01000000, bhvStar),
		OBJECT(MODEL_STRETCH_CLOUD, 14706, 3394, -17464, 0, 0, 0, 0x00000000, bhvStretchCloud),
		...
		OBJECT(MODEL_STRETCH_CLOUD, 11069, 3063, -17541, 0, 0, 0, 0x00000000, bhvStretchCloud),
