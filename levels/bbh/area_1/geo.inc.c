...
const GeoLayout bbh_dl_11__Ground_geo[] = {
	...
	GEO_OPEN_NODE(),
		GEO_ROTATION_NODE(LAYER_OPAQUE, 0, 90, 0),
		GEO_OPEN_NODE(),
			GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -10316, 516, -5779, 0, -83, 0, bbh_dl_BigCloud_mesh_layer_1),
			...
			GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_ALPHA, -9154, 726, 1229, 0, -90, 0, bbh_dl_Flower_002_mesh_layer_4),
			...
			GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -13865, -1800, 4880, 0, -90, 0, bbh_dl_GenericCloudPlats2_001_mesh_layer_1),
