...
const GeoLayout bbh_dl_11__Ground_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -11117, 2339, -4308, 0, -83, 0, bbh_dl_BigCloud_004_mesh_layer_1),
			...
			GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 662, 331, -13699, 0, -90, 0, bbh_dl_Clouds_003_mesh_layer_1),
			GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 18198, 907, -20998, -90, 0, -45, bbh_dl_Clouds_004_mesh_layer_1),
			GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 14826, 2445, -791, 0, -90, 0, bbh_dl_Clouds_005_mesh_layer_1),
			GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 9306, 1771, -11591, 0, -90, 0, bbh_dl_Clouds_006_mesh_layer_1),
			...
			GEO_OPEN_NODE(),
				...
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_ROTATE(LAYER_OPAQUE, -4555, 1694, 6164, 0, -90, 0),
			GEO_OPEN_NODE(),
				GEO_RENDER_RANGE(-4096, 8192),
				GEO_OPEN_NODE(),
