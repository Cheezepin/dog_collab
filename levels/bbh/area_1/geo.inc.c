	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_ROTATE(LAYER_OPAQUE, -15621, -905, 13621, 0, -90, 0),
			GEO_OPEN_NODE(),
				GEO_ASM(1, geo_comit_cpu_fog),
			...
			GEO_ROTATION_NODE_WITH_DL(LAYER_OPAQUE, 0, -90, 0, bbh_dl_Scaffolding2_mesh_layer_1),
			...
			GEO_ROTATION_NODE_WITH_DL(LAYER_OPAQUE, 0, -90, 0, bbh_dl_ZBuilding_mesh_layer_1),
		GEO_CLOSE_NODE(),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
