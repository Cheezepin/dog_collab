...
const GeoLayout bbh_dl_41__Land_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -196602, 0, 0, bbh_dl_Building_003_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -196602, 0, 0, bbh_dl_CloudIsland3_002_mesh_layer_1),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, -196602, 0, 0),
		GEO_OPEN_NODE(),
