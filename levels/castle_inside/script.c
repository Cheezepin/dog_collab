...
const LevelScript level_castle_inside_entry[] = {
	...
	AREA(1, castle_inside_area_1),
		...
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, 2026, 0, -215, 0, -90, 0, 0x00000000, bhvDoorCutscene),
		OBJECT(MODEL_CASTLE_CASTLE_DOOR, 2026, 0, 60, 0, 90, 0, 0x00000000, bhvDoorCutscene),
