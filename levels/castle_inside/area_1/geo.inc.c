...
const GeoLayout castle_inside_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, castle_inside_dl_op_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT_DECAL, castle_inside_dl_op_mesh_layer_6),
		GEO_DISPLAY_LIST(LAYER_ALPHA, castle_inside_dl_op_mesh_layer_4),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
