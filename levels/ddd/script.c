...
const LevelScript level_ddd_entry[] = {
	...
	AREA(1, ddd_area_1),
		...
		INSTANT_WARP(0x02, 0x02, 0, 0, -10000),
	...
	AREA(2, ddd_area_2),
		...
		INSTANT_WARP(0x02, 0x03, -20000, 10000, 0),
		OBJECT(MODEL_DDD_WATER_SPOUT, 1200, -7600, -2200, 0, 0, 0, (1 << 16), bhvWaterSpout),
		OBJECT_WITH_ACTS(MODEL_WATER_PLANE1, 700, -9470, -2200, 0, 0, 0, (1 << 16), bhvWaterSwitchWater1, ACT_1),
		...
		OBJECT(MODEL_FLIPPY_BITCH, -700, -7400, -1600, 0, -90, 0, 0x00000000, bhvFlippyBitch),
		...
		OBJECT(MODEL_WATER_SWITCH, -1100, -7100, -300, 0, 0, 0, (1 << 16), bhvWaterSwitch),
		OBJECT(MODEL_WATER_SWITCH, -3100, -4100, -6400, 0, 0, 0, (0xFF << 24) | (3 << 16), bhvWaterSwitch),
		OBJECT(MODEL_WATER_SWITCH, 0, 3500, -3231, 0, 0, 0, (0xFF << 24) | (4 << 16), bhvWaterSwitch),
		MARIO_POS(0x02, 0, 400, -9300, -3700),
		OBJECT(MODEL_NONE, 400, -9300, -3700, 0, 0, 0, (0x0A << 16), bhvSpinAirborneWarp),
		...
		OBJECT(MODEL_STAR, -3100, -5200, -800, 0, 0, 0, (2 << 24), bhvStar),
		...
		OBJECT(MODEL_STAR, 5300, -7433, 6400, 0, 0, 0, (3 << 24), bhvStar),
		OBJECT(MODEL_STAR, 7500, 3000, -1300, 0, 0, 0, (4 << 24), bhvStar),
		...
		OBJECT(MODEL_STAR, 1, 3660, -1731, 0, 0, 0, (5 << 24), bhvStar),
	...
	AREA(3, ddd_area_3),
		...
		OBJECT(MODEL_STAR, 12413, 7082, -2950, 0, 0, 0, (1 << 24), bhvStar),
