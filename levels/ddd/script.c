...
const LevelScript level_ddd_entry[] = {
	...
	AREA(2, ddd_area_2),
		...
		OBJECT(MODEL_NONE, 200, -8600, -2200, 0, 0, 0, (0x0A << 16), bhvSpinAirborneWarp),
		...
		OBJECT(MODEL_RAIN_CLOUD, -4731, 2500, 0, 0, 0, 0, 0x00000000, bhvRainCloud),
		OBJECT(MODEL_DOG, -4098, 2282, 0, 0, 0, 0, 0x00000000, bhvCoziesDog),
