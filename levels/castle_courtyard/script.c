...
const LevelScript level_castle_courtyard_entry[] = {
    ...
    AREA(/*index*/ 1, castle_courtyard_geo_000218),
        ...
        OBJECT(/*model*/ MODEL_NONE, /*pos*/     0,   151, -1000, /*angle*/ 0, 180, 0, /*behParam*/ 0x000A0000, /*beh*/ bhvLaunchStarCollectWarp),
        OBJECT(/*model*/ MODEL_NONE, /*pos*/     0,   151, -1000, /*angle*/ 0, 180, 0, /*behParam*/ 0x000B0000, /*beh*/ bhvLaunchDeathWarp),
