...
const LevelScript level_bitdw_entry[] = {
	...
	AREA(1, bitdw_area_1),
		...
		OBJECT(MODEL_RED_COIN, 9496, -4891, -538, 0, 0, 0, (0 << 16), bhvRedCoin),
		OBJECT(MODEL_RED_COIN, 13196, 3020, -6466, 0, 0, 0, (0 << 16), bhvRedCoin),
		OBJECT(MODEL_RED_COIN, 8785, 2967, -375, 0, 0, 0, (0 << 16), bhvRedCoin),
		OBJECT(MODEL_RED_COIN, 14332, 2907, -1315, 0, 0, 0, (0 << 16), bhvRedCoin),
		OBJECT(MODEL_RED_COIN, 9431, 2945, 951, 0, 0, 0, (0 << 16), bhvRedCoin),
		OBJECT(MODEL_RED_COIN, 4194, 3047, 10187, 0, 0, 0, (0 << 16), bhvRedCoin),
		OBJECT(MODEL_RED_COIN, 11204, 5367, 7087, 0, 0, 0, (0 << 16), bhvRedCoin),
		OBJECT(MODEL_RED_COIN, 8456, 3051, 2881, 0, 0, 0, (0 << 16), bhvRedCoin),
