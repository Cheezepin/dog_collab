...
const LevelScript level_bitdw_entry[] = {
	...
	AREA(1, bitdw_area_1),
		...
		WARP_NODE(0x0B, LEVEL_BOWSER_2, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		...
		OBJECT(MODEL_NONE, 4807, -2267, 8107, 0, 143, 0, 0x00000000, bhvCoinFormation),
		...
		OBJECT(MODEL_NONE, 8537, -841, 6567, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
