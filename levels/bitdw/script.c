...
const LevelScript level_bitdw_entry[] = {
	...
	AREA(1, bitdw_area_1),
		...
		OBJECT(0x1AA, 2909, 632, 8130, 0, 0, 0, 0x00000000, bhvEmuLift),
		OBJECT(MODEL_NONE, 2893, 2047, 6465, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
	...
	AREA(2, bitdw_area_2),
		...
		OBJECT(0x1F8, 14126, 3752, -2671, 0, 0, 0, 0x00000000, bhvMotos),
		OBJECT(0x1F8, 13643, 3752, -4939, 0, 0, 0, 0x00000000, bhvMotos),
		OBJECT(0x1F8, 10086, 3752, -6745, 0, 0, 0, 0x00000000, bhvMotos),
