...
const LevelScript level_bitdw_entry[] = {
	...
	LOAD_MODEL_FROM_GEO(MODEL_BITDW_SIMPLE_SPINNER_SHOCK, simple_spinner_shock_geo), 
	...
	AREA(1, bitdw_area_1),
		...
		OBJECT(MODEL_NONE, 12030, -3352, 8739, 0, 0, 0, 0x000A0000, bhvSpinAirborneWarp),
	...
	AREA(2, bitdw_area_2),
		...
		OBJECT(0x1AC, 11274, 3060, -3927, 0, 0, 0, 0x00000010, bhvSimpleSpinner),
		OBJECT(0x1AC, 11274, 948, -3927, 0, 0, 0, 0x00000010, bhvSimpleSpinner),
		OBJECT(0x1AE, 11274, 2056, -3927, 0, 0, 0, 0x10000300, bhvSimpleSpinnerShock),
		OBJECT(0x1AE, 11274, -55, -3927, 0, 0, 0, 0x10000300, bhvSimpleSpinnerShock),
		OBJECT(0x1AC, 11274, -1071, -3927, 0, 0, 0, 0x00000010, bhvSimpleSpinner),
		OBJECT(0x1AE, 11274, -2074, -3927, 0, 0, 0, 0x10000300, bhvSimpleSpinnerShock),
