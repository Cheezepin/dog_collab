...
const GeoLayout bitdw_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 4695, 1864, -10724),
		...
		GEO_OPEN_NODE(),
			...
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 10963, -5680, 11286, bitdw_dl_first_walljumps_right_side_mesh_layer_1),
		...
		GEO_OPEN_NODE(),
			GEO_TRANSLATE_NODE(LAYER_OPAQUE, 5641, -4330, -65),
			GEO_OPEN_NODE(),
				...
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_NODE(LAYER_OPAQUE, 5105, -3674, 3762),
			GEO_OPEN_NODE(),
				GEO_RENDER_RANGE(0, 10000),
				GEO_OPEN_NODE(),
				...
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_NODE(LAYER_OPAQUE, -1949, -1287, -994),
			GEO_OPEN_NODE(),
				GEO_RENDER_RANGE(0, 10000),
				GEO_OPEN_NODE(),
				...
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_NODE(LAYER_OPAQUE, -900, -452, -926),
			GEO_OPEN_NODE(),
				GEO_RENDER_RANGE(0, 10000),
				GEO_OPEN_NODE(),
				...
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_NODE(LAYER_OPAQUE, -1635, -841, -1523),
			GEO_OPEN_NODE(),
				GEO_RENDER_RANGE(0, 10000),
				GEO_OPEN_NODE(),
				...
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_NODE(LAYER_OPAQUE, -1486, -452, -926),
			GEO_OPEN_NODE(),
				GEO_RENDER_RANGE(0, 10000),
				GEO_OPEN_NODE(),
				...
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_NODE(LAYER_OPAQUE, -1083, -283, -1523),
			GEO_OPEN_NODE(),
				GEO_RENDER_RANGE(0, 10000),
				GEO_OPEN_NODE(),
				...
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_NODE(LAYER_OPAQUE, 424, -1134, -1282),
			GEO_OPEN_NODE(),
				GEO_RENDER_RANGE(0, 10000),
				GEO_OPEN_NODE(),
				...
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_NODE(LAYER_OPAQUE, 897, -997, -362),
			GEO_OPEN_NODE(),
				GEO_RENDER_RANGE(0, 10000),
				GEO_OPEN_NODE(),
				...
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_NODE(LAYER_OPAQUE, -246, -892, -1619),
			GEO_OPEN_NODE(),
				GEO_RENDER_RANGE(0, 10000),
				GEO_OPEN_NODE(),
				...
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_NODE(LAYER_OPAQUE, 548, -838, 580),
			GEO_OPEN_NODE(),
				GEO_RENDER_RANGE(0, 10000),
				GEO_OPEN_NODE(),
				...
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_NODE(LAYER_OPAQUE, 6686, -1445, 2161),
			GEO_OPEN_NODE(),
				GEO_RENDER_RANGE(0, 10000),
				GEO_OPEN_NODE(),
				...
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_NODE(LAYER_OPAQUE, -1356, -1159, 2023),
			GEO_OPEN_NODE(),
				GEO_RENDER_RANGE(0, 10000),
				GEO_OPEN_NODE(),
				...
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_NODE(LAYER_OPAQUE, -2088, -1874, 2402),
			GEO_OPEN_NODE(),
				GEO_RENDER_RANGE(0, 10000),
				GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 6814, 1817, -9008),
		GEO_OPEN_NODE(),
			GEO_RENDER_RANGE(-4096, 10000),
			GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_NODE(LAYER_OPAQUE, 0, -193, 0),
			GEO_OPEN_NODE(),
				GEO_RENDER_RANGE(10000, 30000),
				GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_NODE(LAYER_OPAQUE, 916, -2248, 32),
			GEO_OPEN_NODE(),
				GEO_RENDER_RANGE(0, 10000),
				GEO_OPEN_NODE(),
				...
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_NODE(LAYER_OPAQUE, 3076, -2687, 47),
			GEO_OPEN_NODE(),
				GEO_RENDER_RANGE(0, 10000),
				GEO_OPEN_NODE(),
				...
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, 280, -274, -1447, bitdw_dl_TOWER_003_mesh_layer_5),
			GEO_RENDER_RANGE(10000, 30000),
			GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			GEO_TRANSLATE_NODE(LAYER_OPAQUE, 3855, -441, 527),
			GEO_OPEN_NODE(),
				GEO_RENDER_RANGE(0, 10000),
				GEO_OPEN_NODE(),
				...
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_NODE(LAYER_OPAQUE, -1554, 1415, -1154),
			GEO_OPEN_NODE(),
				GEO_RENDER_RANGE(-4096, 10000),
				GEO_OPEN_NODE(),
				...
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_NODE(LAYER_OPAQUE, 770, -3157, 2441),
			GEO_OPEN_NODE(),
				GEO_RENDER_RANGE(0, 10000),
				GEO_OPEN_NODE(),
				...
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_NODE(LAYER_OPAQUE, -4983, 4042, -2787),
			GEO_OPEN_NODE(),
				GEO_RENDER_RANGE(0, 10000),
				GEO_OPEN_NODE(),
		...
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 5080, -1998, 6321),
		GEO_OPEN_NODE(),
			GEO_RENDER_RANGE(-4096, 10000),
			GEO_OPEN_NODE(),
			...
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 5691, -1154, 6331),
		GEO_OPEN_NODE(),
			GEO_RENDER_RANGE(-4096, 10000),
			GEO_OPEN_NODE(),
