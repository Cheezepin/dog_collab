...
void scroll_bitdw_dl_temporary_chain_mesh_layer_1_vtx_0() {
	int i = 0;
	int count = 1440;
	int width = 32 * 0x20;
	int height = 32 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(bitdw_dl_temporary_chain_mesh_layer_1_vtx_0);
...
void scroll_bitdw() {
	...
	scroll_bitdw_dl_temporary_chain_mesh_layer_1_vtx_0();
}
