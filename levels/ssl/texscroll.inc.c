...
void scroll_ssl_dl_Plane_mesh_layer_1_vtx_0() {
	...
	deltaX = (int)(0.03999999165534973 * 0x20) % width;
...
void scroll_ssl_dl_Plane_001_mesh_layer_1_vtx_0() {
	int i = 0;
	int count = 163;
	int width = 64 * 0x20;
	int height = 64 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(ssl_dl_Plane_001_mesh_layer_1_vtx_0);
