...
const LevelScript level_ssl_entry[] = {
	...
	AREA(1, ssl_area_1),
		...
		OBJECT(MODEL_NONE, 4715, -2590, 6057, 0, 23, 0, 0x00000000, bhvGoombaTripletSpawner),
		OBJECT(MODEL_NONE, 4796, 491, 3596, 0, 23, 0, 0x00000000, bhvGoombaTripletSpawner),
		OBJECT(MODEL_NONE, -5505, 3002, -4592, 0, 23, 0, 0x00000000, bhvGoombaTripletSpawner),
		OBJECT(MODEL_NONE, -7372, 3023, 2155, 0, 23, 0, 0x00000000, bhvGoombaTripletSpawner),
		OBJECT(MODEL_NONE, 2162, -2874, 1508, 0, 23, 0, 0x00000000, bhvGoombaTripletSpawner),
		...
		OBJECT(MODEL_STROLLIN_STU, 6810, 476, -1813, 0, -110, 0, (4 << 16), bhvStrollinStu),
		OBJECT(MODEL_STROLLIN_STU, -6114, 476, -6234, 0, -110, 0, (4 << 16), bhvStrollinStu),
