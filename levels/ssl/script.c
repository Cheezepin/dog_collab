...
const LevelScript level_ssl_entry[] = {
	...
	AREA(1, ssl_area_1),
		...
		OBJECT(MODEL_NONE, 634, -1054, 6006, 0, -86, 0, 0x00000000, bhvCoinFormation),
		...
		OBJECT(MODEL_NONE, -2643, 1808, 5611, 0, 0, 0, (2 << 16), bhvCoinFormation),
		OBJECT(MODEL_NONE, -6218, 2961, 3855, 0, 0, 0, (2 << 16), bhvCoinFormation),
		...
		OBJECT(MODEL_NONE, -4752, 3002, 4378, 0, 0, 0, 0x00000000, bhvGoombaTripletSpawner),
		...
		OBJECT(MODEL_STROLLIN_STU, -3186, 1434, 6743, 0, -62, 0, (1 << 24) | (4 << 16), bhvStrollinStu),
		OBJECT(MODEL_STROLLIN_STU, 3959, 4023, 1770, 0, -110, 0, (1 << 24) | (4 << 16), bhvStrollinStu),
		OBJECT(MODEL_STROLLIN_STU, -3833, 2169, 5499, 0, -62, 0, (1 << 24) | (4 << 16), bhvStrollinStu),
