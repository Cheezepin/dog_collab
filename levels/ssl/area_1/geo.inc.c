...
const GeoLayout ssl_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -4726, -3787, 4359, 0, -39, 0, ssl_dl_Cylinder_066_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -3130, 1237, 6722, 0, 11, 0, ssl_dl_Cylinder_067_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -2638, 1612, 5592, 0, 45, 0, ssl_dl_Cylinder_068_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -3836, 1972, 5521, 0, 20, 0, ssl_dl_Cylinder_069_mesh_layer_1),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -6206, 2764, 3870, 0, 20, 0, ssl_dl_Cylinder_070_mesh_layer_1),
