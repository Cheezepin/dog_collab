...
const LevelScript level_bowser_2_entry[] = {
	...
	AREA(1, bowser_2_area_1),
		...
		OBJECT(MODEL_BOWSER_BOMB, 3016, 356, -3146, 0, -135, 0, 0x00000000, bhvBowserBomb),
		OBJECT(MODEL_BOWSER_BOMB, 4542, 356, -92, 0, -180, 0, 0x00000000, bhvBowserBomb),
		OBJECT(MODEL_BOWSER_BOMB, 130, 356, -4449, 0, -90, 0, 0x00000000, bhvBowserBomb),
		OBJECT(MODEL_BOWSER_BOMB, -3016, 356, -3146, 0, -45, 0, 0x00000000, bhvBowserBomb),
		OBJECT(MODEL_BOWSER_BOMB, -4319, 356, 0, 0, 0, 0, 0x00000000, bhvBowserBomb),
		OBJECT(MODEL_BOWSER_BOMB, -3016, 356, 3146, 0, 45, 0, 0x00000000, bhvBowserBomb),
		OBJECT(MODEL_BOWSER_BOMB, 130, 356, 4449, 0, 90, 0, 0x00000000, bhvBowserBomb),
		OBJECT(MODEL_BOWSER_BOMB, 3277, 356, 3146, 0, 135, 0, 0x00000000, bhvBowserBomb),
