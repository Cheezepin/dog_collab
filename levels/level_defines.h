...
DEFINE_LEVEL("COURSE 7 LLL", LEVEL_LLL, COURSE_LLL, lll, fire, 20000, 0x00, 0x00, 0x3F, _, sCamLLL) 
DEFINE_LEVEL("COURSE 9 DDD", LEVEL_DDD, COURSE_DDD, ddd, water, 20000, 0x00, 0x38, 0x40, _, sCamDDD) 
DEFINE_LEVEL("COURSE 2 WF", LEVEL_WF, COURSE_WF, wf, grass, 20000, 0x00, 0x0A, 0x00, _, sCamWF) 
