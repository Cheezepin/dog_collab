...
COURSE_ACTS(COURSE_BBH, _(" 5 CUMULUS CORRECTIONAL CENTER"),
       _("TAKING THE TOUR")               , _("LOST IN THE CLOUDS")            , _("RED COINS IN THE FACILITY"),
       _("RAINBOW RIDE TO THE TOWER")     , _("THE THUNDEROUS TROUBLEMAKERS")  , _("CLEANUP ON AISLE FWOOSH!"))

COURSE_ACTS(COURSE_HMC, _(" 6 FORBIDDEN FACTORY"),
       _("TURN ON THE GENERATOR")  , _("UNLOCK THE MAINTENANCE ROOM")       , _("RED COINS WITH FREE SHIPPING"),
       _("PRODUCTION LINE RUSH")     , _("RED BLOCK ROUNDUP")     , _("KING GOOPA BENEATH THE SCENES"))
...
COURSE_ACTS(COURSE_SL, _("10 UPTURNED DEEPS"),
       _("THE ELDER'S REQUEST")            , _("CHILL WITH THE BULLY")          , _("IN THE DEEP FREEZE"),
