...
const Texture *const main_hud_lut[] = {
    ...
    texture_hud_char_outline_star /* @ */,  texture_hud_char_A,             texture_hud_char_B,             texture_hud_char_C,
    ...
    texture_hud_char_T,                     texture_hud_char_U,             texture_hud_char_V,             texture_hud_char_W,
    texture_hud_char_X,                     texture_hud_char_Y,             texture_hud_char_Z,             0x0 /* { */,
    0x0 /* | */,                            0x0 /* } */,                    texture_hud_char_tilde,         0x0 /* DEL */,
};

// remaps > 244 to hud lut, ia4 text equivalent shown on right
const u8 main_hud_244_lut[] = {
    0x0, // 0x0,
    '"', // texture_font_char_us_double_quote_open,
    '"', // texture_font_char_us_double_quote_close,
    0x0, // 0x0,
    0x0, // texture_font_char_100_percent,
    '+', // texture_font_char_us_coin,
    '-', // texture_font_char_us_star_filled,
    0x0, // 0x0,
    0x0, // texture_font_char_us_interpunct,
...
const Texture *const main_font_lut[] = {
    ...
    texture_font_char_us_8, texture_font_char_us_9, texture_font_char_us_ellipsis /* : */, 0x0 /* ; */, // texture_font_char_us_u, texture_font_char_us_v, texture_font_char_us_w, texture_font_char_us_x,
    ...
    0x0 /* | */, 0x0 /* } */, texture_font_char_us_tilde, 0x0 /* DEL */, // End of ASCII table
    ...
    0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, texture_font_char_us_close_open_parentheses, 0x0,
    texture_font_char_us_left_right_arrow, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x0,
...
static const Vtx vertex_text_bg_box[] = {
    ...
    {{{ DIALOG_BOX_WIDTH, -80, 0 }, 0, { 0, 0 }, {0xff, 0xff, 0xff, 0xff}}},
    {{{ DIALOG_BOX_WIDTH,   0, 0 }, 0, { 0, 0 }, {0xff, 0xff, 0xff, 0xff}}},
