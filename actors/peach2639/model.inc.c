...
// 0x050009F8
static const Lights1 peach2639_seg5_lights_050009F8 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x05000A10
static const Lights1 peach2639_seg5_lights_05000A10 = gdSPDefLights1(
    0x7f, 0x5f, 0x0c,
    0xff, 0xbf, 0x18, 0x28, 0x28, 0x28
);

// 0x05000A28
ALIGNED8 static const Texture peach2639_seg5_texture_05000A28[] = {
#include "actors/peach2639/peach_eye_open.rgba16.inc.c"
};

// 0x05001228
ALIGNED8 static const Texture peach2639_seg5_texture_05001228[] = {
#include "actors/peach2639/peach_eye_mostly_open.rgba16.inc.c"
};

// 0x05001A28
ALIGNED8 static const Texture peach2639_seg5_texture_05001A28[] = {
#include "actors/peach2639/peach_eye_mostly_closed.rgba16.inc.c"
};

// 0x05002228
ALIGNED8 static const Texture peach2639_seg5_texture_05002228[] = {
#include "actors/peach2639/peach_eye_closed.rgba16.inc.c"
};

// 0x05002A28
ALIGNED8 static const Texture peach2639_seg5_texture_05002A28[] = {
#include "actors/peach2639/peach_crown_jewel.rgba16.inc.c"
};

// 0x05002C28
ALIGNED8 static const Texture peach2639_seg5_texture_05002C28[] = {
#include "actors/peach2639/peach_chest_jewel.rgba16.inc.c"
};

// 0x05002E28
ALIGNED8 static const Texture peach2639_seg5_texture_05002E28[] = {
#include "actors/peach2639/peach_lips_scrunched.rgba16.inc.c"
};

// 0x05003628
ALIGNED8 static const Texture peach2639_seg5_texture_05003628[] = {
#include "actors/peach2639/peach_lips.rgba16.inc.c"
};

// 0x05003E28
ALIGNED8 static const Texture peach2639_seg5_texture_05003E28[] = {
#include "actors/peach2639/peach_nostril.rgba16.inc.c"
};

// 0x05004028
ALIGNED8 static const Texture peach2639_seg5_texture_05004028[] = {
#include "actors/peach2639/peach_dress.rgba16.inc.c"
};

// 0x05004828
static const Vtx peach2639_seg5_vertex_05004828[] = {
...
// 0x05004928
static const Vtx peach2639_seg5_vertex_05004928[] = {
    {{{   165,    -43,      0}, 0, {   224,    496}, {0x4b, 0x9a, 0x00, 0xff}}},
    {{{   214,    -40,      0}, 0, {   223,   -306}, {0x74, 0xcd, 0xfd, 0xff}}},
...
// 0x05004A18
static const Vtx peach2639_seg5_vertex_05004A18[] = {
...
// 0x05004AA8
static const Vtx peach2639_seg5_vertex_05004AA8[] = {
...
// 0x05004AD8
static const Vtx peach2639_seg5_vertex_05004AD8[] = {
...
// 0x05004BD8
static const Vtx peach2639_seg5_vertex_05004BD8[] = {
    {{{     1,     38,    -34}, 0, {  -380,   -670}, {0x9a, 0x03, 0xb6, 0xff}}},
    {{{   -10,     -6,      0}, 0, {    40,   -324}, {0x82, 0xf1, 0x00, 0xff}}},
...
// 0x05004CC8
static const Vtx peach2639_seg5_vertex_05004CC8[] = {
...
// 0x05004DB8
static const Vtx peach2639_seg5_vertex_05004DB8[] = {
    {{{    45,     79,     37}, 0, {   714,    746}, {0xf1, 0x6f, 0x3a, 0xff}}},
...
// 0x05004E38
static const Vtx peach2639_seg5_vertex_05004E38[] = {
...
// 0x05004E88
static const Vtx peach2639_seg5_vertex_05004E88[] = {
...
// 0x05004F78
static const Vtx peach2639_seg5_vertex_05004F78[] = {
    {{{    59,     -8,     86}, 0, {     0,      0}, {0xcd, 0x1d, 0x6f, 0xff}}},
...
// 0x05005078
static const Vtx peach2639_seg5_vertex_05005078[] = {
    {{{    35,     37,    -76}, 0, {     0,      0}, {0xd0, 0x29, 0x92, 0xff}}},
    {{{    59,     -8,    -85}, 0, {     0,      0}, {0xcd, 0x1d, 0x91, 0xff}}},
...
// 0x05005168
static const Vtx peach2639_seg5_vertex_05005168[] = {
...
// 0x05005268
static const Vtx peach2639_seg5_vertex_05005268[] = {
    {{{   131,    -87,      0}, 0, {     0,      0}, {0x44, 0x96, 0x00, 0xff}}},
    {{{    98,    -89,    -74}, 0, {     0,      0}, {0x31, 0x98, 0xcc, 0xff}}},
    {{{   131,    -79,    -38}, 0, {     0,      0}, {0x57, 0xb2, 0xd1, 0xff}}},
    {{{   134,    -13,    -79}, 0, {     0,      0}, {0x4d, 0xd6, 0xa5, 0xff}}},
...
// 0x05005368
static const Vtx peach2639_seg5_vertex_05005368[] = {
...
// 0x05005468
static const Vtx peach2639_seg5_vertex_05005468[] = {
    {{{    98,    -89,     75}, 0, {     0,      0}, {0x31, 0x97, 0x33, 0xff}}},
    {{{    98,    -98,      0}, 0, {     0,      0}, {0x1f, 0x86, 0x00, 0xff}}},
    {{{   131,    -87,      0}, 0, {     0,      0}, {0x44, 0x96, 0x00, 0xff}}},
    {{{   165,    -43,      0}, 0, {     0,      0}, {0x4b, 0x9a, 0x00, 0xff}}},
...
// 0x05005568
static const Vtx peach2639_seg5_vertex_05005568[] = {
    {{{    98,    -89,     75}, 0, {     0,      0}, {0x31, 0x97, 0x33, 0xff}}},
    {{{   134,    -13,     80}, 0, {     0,      0}, {0x4d, 0xd6, 0x5b, 0xff}}},
    {{{    92,    -29,    104}, 0, {     0,      0}, {0x36, 0x08, 0x72, 0xff}}},
...
const Gfx peach2639_seg5_dl_05005648[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, peach2639_seg5_texture_05002A28),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 16 * 16 - 1, CALC_DXT(16, G_IM_SIZ_16b_BYTES)),
    gsSPLight(&peach2639_seg5_lights_050009F8.l, 1),
    gsSPLight(&peach2639_seg5_lights_050009F8.a, 2),
    gsSPVertex(peach2639_seg5_vertex_05004828, 16, 0),
...
const Gfx peach2639_seg5_dl_05005750[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, peach2639_seg5_texture_05003E28),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 16 * 16 - 1, CALC_DXT(16, G_IM_SIZ_16b_BYTES)),
    gsSPVertex(peach2639_seg5_vertex_05004AA8, 3, 0),
    gsSP1Triangle( 0,  1,  2, 0x0),
    gsSPEndDisplayList(),
};

// 0x05005780 - 0x050058B8
const Gfx peach2639_seg5_dl_05005780[] = {
    gsSPVertex(peach2639_seg5_vertex_05004AD8, 16, 0),
    ...
    gsSPVertex(peach2639_seg5_vertex_05004DB8, 8, 0),
...
const Gfx peach2639_seg5_dl_050058B8[] = {
    gsSPVertex(peach2639_seg5_vertex_05004E38, 5, 0),
...
const Gfx peach2639_seg5_dl_050058E0[] = {
    gsSPLight(&peach2639_seg5_lights_05000A10.l, 1),
    gsSPLight(&peach2639_seg5_lights_05000A10.a, 2),
    gsSPVertex(peach2639_seg5_vertex_05004E88, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  0,  4, 0x0),
    ...
    gsSPVertex(peach2639_seg5_vertex_05004F78, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  1,  0, 0x0),
    ...
    gsSPVertex(peach2639_seg5_vertex_05005078, 15, 0),
    ...
    gsSPVertex(peach2639_seg5_vertex_05005168, 16, 0),
    ...
    gsSPVertex(peach2639_seg5_vertex_05005268, 16, 0),
    ...
    gsSPVertex(peach2639_seg5_vertex_05005368, 16, 0),
    ...
    gsSPVertex(peach2639_seg5_vertex_05005468, 16, 0),
    ...
    gsSPVertex(peach2639_seg5_vertex_05005568, 14, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  1, 0x0),
...
const Gfx peach2639_seg5_dl_05005C48[] = {
    gsDPPipeSync(),
    ...
    gsSPDisplayList(peach2639_seg5_dl_05005648),
    gsSPDisplayList(peach2639_seg5_dl_05005750),
    gsDPTileSync(),
...
const Gfx peach2639_seg5_dl_05005CB0[] = {
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_OFF),
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADEFADEA, G_CC_SHADEFADEA),
    gsSPDisplayList(peach2639_seg5_dl_050058E0),
    gsDPPipeSync(),
    gsSPEndDisplayList(),
};

// 0x05005CE0 - 0x05005D38
const Gfx peach2639_seg5_dl_05005CE0[] = {
    gsSPDisplayList(peach2639_seg5_dl_05005C48),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, peach2639_seg5_texture_05000A28),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPDisplayList(peach2639_seg5_dl_05005780),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, peach2639_seg5_texture_05002E28),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPDisplayList(peach2639_seg5_dl_050058B8),
    gsSPDisplayList(peach2639_seg5_dl_05005CB0),
    gsSPEndDisplayList(),
};

// 0x05005D38 - 0x05005D90
const Gfx peach2639_seg5_dl_05005D38[] = {
    gsSPDisplayList(peach2639_seg5_dl_05005C48),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, peach2639_seg5_texture_05001228),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPDisplayList(peach2639_seg5_dl_05005780),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, peach2639_seg5_texture_05002E28),
...
const Gfx peach2639_seg5_dl_05005D90[] = {
    gsSPDisplayList(peach2639_seg5_dl_05005C48),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, peach2639_seg5_texture_05001A28),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPDisplayList(peach2639_seg5_dl_05005780),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, peach2639_seg5_texture_05002E28),
...
const Gfx peach2639_seg5_dl_05005DE8[] = {
    gsSPDisplayList(peach2639_seg5_dl_05005C48),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, peach2639_seg5_texture_05002228),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPDisplayList(peach2639_seg5_dl_05005780),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, peach2639_seg5_texture_05002E28),
...
const Gfx peach2639_seg5_dl_05005E40[] = {
    gsSPDisplayList(peach2639_seg5_dl_05005C48),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, peach2639_seg5_texture_05000A28),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPDisplayList(peach2639_seg5_dl_05005780),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, peach2639_seg5_texture_05003628),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPDisplayList(peach2639_seg5_dl_050058B8),
    gsSPDisplayList(peach2639_seg5_dl_05005CB0),
...
const Gfx peach2639_seg5_dl_05005E98[] = {
    gsSPDisplayList(peach2639_seg5_dl_05005C48),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, peach2639_seg5_texture_05001228),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
const Gfx peach2639_seg5_dl_05005EF0[] = {
    gsSPDisplayList(peach2639_seg5_dl_05005C48),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, peach2639_seg5_texture_05001A28),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
const Gfx peach2639_seg5_dl_05005F48[] = {
    gsSPDisplayList(peach2639_seg5_dl_05005C48),
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, peach2639_seg5_texture_05002228),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
...
// 0x05005FA0
static const Lights1 peach2639_seg5_lights_05005FA0 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x05005FB8
static const Vtx peach2639_seg5_vertex_05005FB8[] = {
...
const Gfx peach2639_seg5_dl_05006058[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, peach2639_seg5_texture_05000A28),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPLight(&peach2639_seg5_lights_05005FA0.l, 1),
    gsSPLight(&peach2639_seg5_lights_05005FA0.a, 2),
    gsSPVertex(peach2639_seg5_vertex_05005FB8, 10, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  1,  3,  2, 0x0),
...
const Gfx peach2639_seg5_dl_050060E0[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGBFADE, G_CC_MODULATERGBFADE),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    ...
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 0, G_TX_RENDERTILE, 0, G_TX_CLAMP, 5, G_TX_NOLOD, G_TX_CLAMP, 5, G_TX_NOLOD),
    gsDPSetTileSize(0, 0, 0, (32 - 1) << G_TEXTURE_IMAGE_FRAC, (32 - 1) << G_TEXTURE_IMAGE_FRAC),
    gsSPDisplayList(peach2639_seg5_dl_05006058),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_OFF),
    gsDPPipeSync(),
    gsSPEndDisplayList(),
};
...
// 0x05006138
static const Lights1 peach2639_seg5_lights_05006138 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x05006150
static const Lights1 peach2639_seg5_lights_05006150 = gdSPDefLights1(
    0x6c, 0x54, 0x5f,
    0xd9, 0xa9, 0xbe, 0x28, 0x28, 0x28
);

// 0x05006168
static const Vtx peach2639_seg5_vertex_05006168[] = {
...
// 0x050061E8
static const Vtx peach2639_seg5_vertex_050061E8[] = {
...
// 0x05006238
static const Vtx peach2639_seg5_vertex_05006238[] = {
...
// 0x05006318
static const Vtx peach2639_seg5_vertex_05006318[] = {
...
// 0x05006408
static const Vtx peach2639_seg5_vertex_05006408[] = {
    {{{   111,     45,      0}, 0, {   478,   -586}, {0xef, 0x7b, 0xea, 0xff}}},
    {{{    98,     18,    -34}, 0, {   302,   -522}, {0x2e, 0x52, 0xac, 0xff}}},
    {{{    95,     36,      0}, 0, {   478,   -506}, {0x25, 0x78, 0x0d, 0xff}}},
    {{{    84,     50,    -21}, 0, {   368,   -452}, {0x66, 0x4a, 0xf2, 0xff}}},
...
// 0x050064E8
static const Vtx peach2639_seg5_vertex_050064E8[] = {
...
// 0x050065E8
static const Vtx peach2639_seg5_vertex_050065E8[] = {
    {{{    98,    -23,     35}, 0, {   656,   -520}, {0x42, 0xb8, 0x50, 0xff}}},
    {{{    86,    -53,     35}, 0, {   656,   -460}, {0x41, 0x98, 0x1e, 0xff}}},
    {{{    98,    -23,    -34}, 0, {   302,   -520}, {0x59, 0xcd, 0xb7, 0xff}}},
    {{{    85,    -21,     66}, 0, {   808,   -454}, {0x3a, 0xc5, 0x5f, 0xff}}},
...
// 0x050066E8
static const Vtx peach2639_seg5_vertex_050066E8[] = {
    {{{   116,     24,    -42}, 0, {   266,   -612}, {0x2f, 0x2b, 0x93, 0xff}}},
    {{{   119,    -30,    -35}, 0, {   300,   -626}, {0x40, 0x9f, 0xce, 0xff}}},
    {{{    98,    -23,    -34}, 0, {   302,   -520}, {0x59, 0xcd, 0xb7, 0xff}}},
    {{{    98,     18,    -34}, 0, {   302,   -522}, {0x2e, 0x52, 0xac, 0xff}}},
...
const Gfx peach2639_seg5_dl_05006728[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, peach2639_seg5_texture_05002C28),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 16 * 16 - 1, CALC_DXT(16, G_IM_SIZ_16b_BYTES)),
    gsSPLight(&peach2639_seg5_lights_05006138.l, 1),
    gsSPLight(&peach2639_seg5_lights_05006138.a, 2),
    gsSPVertex(peach2639_seg5_vertex_05006168, 8, 0),
...
const Gfx peach2639_seg5_dl_05006798[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, peach2639_seg5_texture_05004028),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPLight(&peach2639_seg5_lights_05006150.l, 1),
    gsSPLight(&peach2639_seg5_lights_05006150.a, 2),
    gsSPVertex(peach2639_seg5_vertex_050061E8, 5, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  0, 0x0),
    gsSP1Triangle( 3,  0,  2, 0x0),
    gsSPLight(&peach2639_seg5_lights_05006138.l, 1),
    gsSPLight(&peach2639_seg5_lights_05006138.a, 2),
    gsSPVertex(peach2639_seg5_vertex_05006238, 14, 0),
    ...
    gsSPVertex(peach2639_seg5_vertex_05006318, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  2, 0x0),
    ...
    gsSPVertex(peach2639_seg5_vertex_050065E8, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  1,  0, 0x0),
    ...
    gsSPVertex(peach2639_seg5_vertex_050066E8, 4, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  2,  3,  0, 0x0),
    gsSPEndDisplayList(),
};

// 0x05006A18 - 0x05006A90
const Gfx peach2639_seg5_dl_05006A18[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGBFADE, G_CC_MODULATERGBFADE),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    ...
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 4, 0, G_TX_RENDERTILE, 0, G_TX_CLAMP, 4, G_TX_NOLOD, G_TX_CLAMP, 4, G_TX_NOLOD),
    gsDPSetTileSize(0, 0, 0, (16 - 1) << G_TEXTURE_IMAGE_FRAC, (16 - 1) << G_TEXTURE_IMAGE_FRAC),
    gsSPDisplayList(peach2639_seg5_dl_05006728),
    gsDPTileSync(),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 0, G_TX_RENDERTILE, 0, G_TX_CLAMP, 5, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, 5, G_TX_NOLOD),
    gsDPSetTileSize(0, 0, 0, (32 - 1) << G_TEXTURE_IMAGE_FRAC, (32 - 1) << G_TEXTURE_IMAGE_FRAC),
    gsSPDisplayList(peach2639_seg5_dl_05006798),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_OFF),
    gsDPPipeSync(),
    gsSPEndDisplayList(),
};
...
// 0x05006A90
static const Lights1 peach2639_seg5_lights_05006A90 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x05006AA8
static const Vtx peach2639_seg5_vertex_05006AA8[] = {
...
// 0x05006BA8
static const Vtx peach2639_seg5_vertex_05006BA8[] = {
...
// 0x05006CA8
static const Vtx peach2639_seg5_vertex_05006CA8[] = {
    {{{    35,     12,    -80}, 0, {    76,  -1404}, {0x5f, 0x0a, 0xae, 0xff}}},
...
// 0x05006DA8
static const Vtx peach2639_seg5_vertex_05006DA8[] = {
    {{{    57,    -22,      0}, 0, {   478,  -1624}, {0x54, 0xa2, 0xf8, 0xff}}},
...
// 0x05006EA8
static const Vtx peach2639_seg5_vertex_05006EA8[] = {
    {{{   -19,     99,      0}, 0, {   480,   -856}, {0x1c, 0x7b, 0x00, 0xff}}},
...
const Gfx peach2639_seg5_dl_05006FA8[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, peach2639_seg5_texture_05004028),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPLight(&peach2639_seg5_lights_05006A90.l, 1),
    gsSPLight(&peach2639_seg5_lights_05006A90.a, 2),
    gsSPVertex(peach2639_seg5_vertex_05006AA8, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    ...
    gsSPVertex(peach2639_seg5_vertex_05006BA8, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    ...
    gsSPVertex(peach2639_seg5_vertex_05006CA8, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  0,  4, 0x0),
    ...
    gsSPVertex(peach2639_seg5_vertex_05006DA8, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  2,  1, 0x0),
    ...
    gsSP1Triangle(14, 15, 13, 0x0),
    gsSPVertex(peach2639_seg5_vertex_05006EA8, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  0, 0x0),
...
const Gfx peach2639_seg5_dl_05007230[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGBFADE, G_CC_MODULATERGBFADE),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    ...
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 0, G_TX_RENDERTILE, 0, G_TX_CLAMP, 5, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, 5, G_TX_NOLOD),
    gsDPSetTileSize(0, 0, 0, (32 - 1) << G_TEXTURE_IMAGE_FRAC, (32 - 1) << G_TEXTURE_IMAGE_FRAC),
    gsSPDisplayList(peach2639_seg5_dl_05006FA8),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_OFF),
    gsDPPipeSync(),
    gsSPEndDisplayList(),
};
...
const Gfx peach2639_seg5_us_dl_05007288[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGBFADE, G_CC_MODULATERGBFADE),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
...
// 0x05007288
static const Lights1 peach2639_seg5_lights_05007288 = gdSPDefLights1(
    0x7f, 0x5f, 0x0c,
    0xff, 0xbf, 0x18, 0x28, 0x28, 0x28
);

// 0x050072A0
static const Vtx peach2639_seg5_vertex_050072A0[] = {
...
// 0x05007380
static const Vtx peach2639_seg5_vertex_05007380[] = {
...
// 0x05007480
static const Vtx peach2639_seg5_vertex_05007480[] = {
    {{{   136,   -112,     40}, 0, {     0,      0}, {0xf1, 0x84, 0x16, 0xff}}},
    {{{   -27,    -67,     43}, 0, {     0,      0}, {0xbd, 0x98, 0x1b, 0xff}}},
    {{{   -27,    -67,    -43}, 0, {     0,      0}, {0xc6, 0x93, 0xe4, 0xff}}},
    {{{   136,   -112,    -39}, 0, {     0,      0}, {0xfb, 0x84, 0xea, 0xff}}},
...
// 0x05007580
static const Vtx peach2639_seg5_vertex_05007580[] = {
    {{{   229,    -45,    -47}, 0, {     0,      0}, {0x43, 0x4f, 0xb8, 0xff}}},
    {{{   188,    -40,    -84}, 0, {     0,      0}, {0x39, 0x28, 0x97, 0xff}}},
    {{{   184,      6,    -55}, 0, {     0,      0}, {0x35, 0x56, 0xb5, 0xff}}},
    {{{   189,     27,      0}, 0, {     0,      0}, {0x3e, 0x6e, 0x00, 0xff}}},
...
// 0x05007680
static const Vtx peach2639_seg5_vertex_05007680[] = {
    {{{   -95,     -7,     22}, 0, {     0,      0}, {0x86, 0x09, 0x21, 0xff}}},
    {{{   -72,    -14,     66}, 0, {     0,      0}, {0xa7, 0x00, 0x59, 0xff}}},
    {{{   -37,     23,     46}, 0, {     0,      0}, {0xd9, 0x6c, 0x33, 0xff}}},
    {{{   -27,    -67,     43}, 0, {     0,      0}, {0xbd, 0x98, 0x1b, 0xff}}},
...
// 0x05007780
static const Vtx peach2639_seg5_vertex_05007780[] = {
    {{{   184,      6,     56}, 0, {     0,      0}, {0x35, 0x56, 0x4b, 0xff}}},
    {{{   188,    -40,     85}, 0, {     0,      0}, {0x39, 0x28, 0x6a, 0xff}}},
    {{{   229,    -45,     49}, 0, {     0,      0}, {0x43, 0x4f, 0x47, 0xff}}},
    {{{   189,     27,      0}, 0, {     0,      0}, {0x3e, 0x6e, 0x00, 0xff}}},
...
const Gfx peach2639_seg5_dl_05007810[] = {
    gsSPLight(&peach2639_seg5_lights_05007288.l, 1),
    gsSPLight(&peach2639_seg5_lights_05007288.a, 2),
    gsSPVertex(peach2639_seg5_vertex_050072A0, 14, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  2,  4, 0x0),
    ...
    gsSPVertex(peach2639_seg5_vertex_05007380, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  2,  3,  0, 0x0),
    ...
    gsSPVertex(peach2639_seg5_vertex_05007480, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  2,  3,  0, 0x0),
    ...
    gsSPVertex(peach2639_seg5_vertex_05007580, 16, 0),
    ...
    gsSPVertex(peach2639_seg5_vertex_05007680, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  1,  0, 0x0),
    ...
    gsSPVertex(peach2639_seg5_vertex_05007780, 9, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  0,  2, 0x0),
...
const Gfx peach2639_seg5_dl_05007AB8[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADEFADEA, G_CC_SHADEFADEA),
    gsSPDisplayList(peach2639_seg5_dl_05007810),
    gsDPPipeSync(),
    gsSPEndDisplayList(),
};

// 0x05007AE0
static const Lights1 peach2639_seg5_lights_05007AE0 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x05007AF8
static const Vtx peach2639_seg5_vertex_05007AF8[] = {
...
// 0x05007BE8
static const Vtx peach2639_seg5_vertex_05007BE8[] = {
...
const Gfx peach2639_seg5_dl_05007CE8[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, peach2639_seg5_texture_05004028),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPLight(&peach2639_seg5_lights_05007AE0.l, 1),
    gsSPLight(&peach2639_seg5_lights_05007AE0.a, 2),
    gsSPVertex(peach2639_seg5_vertex_05007AF8, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  0, 0x0),
    ...
    gsSPVertex(peach2639_seg5_vertex_05007BE8, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  2,  3,  4, 0x0),
...
const Gfx peach2639_seg5_dl_05007E58[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGBFADE, G_CC_MODULATERGBFADE),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    ...
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 0, G_TX_RENDERTILE, 0, G_TX_CLAMP, 5, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, 5, G_TX_NOLOD),
    gsDPSetTileSize(0, 0, 0, (32 - 1) << G_TEXTURE_IMAGE_FRAC, (32 - 1) << G_TEXTURE_IMAGE_FRAC),
    gsSPDisplayList(peach2639_seg5_dl_05007CE8),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_OFF),
    gsDPPipeSync(),
    gsSPEndDisplayList(),
};
...
// 0x05007EB0
static const Lights1 peach2639_seg5_lights_05007EB0 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x05007EC8
static const Vtx peach2639_seg5_vertex_05007EC8[] = {
...
// 0x05007FB8
static const Vtx peach2639_seg5_vertex_05007FB8[] = {
...
const Gfx peach2639_seg5_dl_050080B8[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, peach2639_seg5_texture_05004028),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPLight(&peach2639_seg5_lights_05007EB0.l, 1),
    gsSPLight(&peach2639_seg5_lights_05007EB0.a, 2),
    gsSPVertex(peach2639_seg5_vertex_05007EC8, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  2,  3,  0, 0x0),
    ...
    gsSPVertex(peach2639_seg5_vertex_05007FB8, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  1,  3,  2, 0x0),
...
const Gfx peach2639_seg5_dl_05008228[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGBFADE, G_CC_MODULATERGBFADE),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    ...
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 0, G_TX_RENDERTILE, 0, G_TX_CLAMP, 5, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, 5, G_TX_NOLOD),
    gsDPSetTileSize(0, 0, 0, (32 - 1) << G_TEXTURE_IMAGE_FRAC, (32 - 1) << G_TEXTURE_IMAGE_FRAC),
    gsSPDisplayList(peach2639_seg5_dl_050080B8),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_OFF),
    gsDPPipeSync(),
    gsSPEndDisplayList(),
};
...
// 0x05008280
static const Lights1 peach2639_seg5_lights_05008280 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x05008298
static const Vtx peach2639_seg5_vertex_05008298[] = {
...
// 0x05008358
static const Vtx peach2639_seg5_vertex_05008358[] = {
...
const Gfx peach2639_seg5_dl_05008428[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, peach2639_seg5_texture_05000A28),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPLight(&peach2639_seg5_lights_05008280.l, 1),
    gsSPLight(&peach2639_seg5_lights_05008280.a, 2),
    gsSPVertex(peach2639_seg5_vertex_05008298, 12, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  3,  1, 0x0),
...
const Gfx peach2639_seg5_dl_050084C0[] = {
    gsSPVertex(peach2639_seg5_vertex_05008358, 13, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  2,  4, 0x0),
...
const Gfx peach2639_seg5_dl_05008560[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGBFADE, G_CC_MODULATERGBFADE),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    ...
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 0, G_TX_RENDERTILE, 0, G_TX_CLAMP, 5, G_TX_NOLOD, G_TX_CLAMP, 5, G_TX_NOLOD),
    gsDPSetTileSize(0, 0, 0, (32 - 1) << G_TEXTURE_IMAGE_FRAC, (32 - 1) << G_TEXTURE_IMAGE_FRAC),
    gsSPDisplayList(peach2639_seg5_dl_05008428),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_OFF),
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADEFADEA, G_CC_SHADEFADEA),
    gsSPDisplayList(peach2639_seg5_dl_050084C0),
    gsDPPipeSync(),
    gsSPEndDisplayList(),
};

// 0x050085D0
static const Lights1 peach2639_seg5_lights_050085D0 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x050085E8
static const Vtx peach2639_seg5_vertex_050085E8[] = {
...
const Gfx peach2639_seg5_dl_050086C8[] = {
    gsSPLight(&peach2639_seg5_lights_050085D0.l, 1),
    gsSPLight(&peach2639_seg5_lights_050085D0.a, 2),
    gsSPVertex(peach2639_seg5_vertex_050085E8, 14, 0),
    gsSP1Triangle( 0,  1,  2, 0x0),
...
const Gfx peach2639_seg5_dl_050087A8[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADEFADEA, G_CC_SHADEFADEA),
    gsSPDisplayList(peach2639_seg5_dl_050086C8),
    gsDPPipeSync(),
    gsSPEndDisplayList(),
};

// 0x050087D0
static const Lights1 peach2639_seg5_lights_050087D0 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x050087E8
static const Vtx peach2639_seg5_vertex_050087E8[] = {
...
// 0x050088A8
static const Vtx peach2639_seg5_vertex_050088A8[] = {
...
const Gfx peach2639_seg5_dl_05008978[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, peach2639_seg5_texture_05000A28),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPLight(&peach2639_seg5_lights_050087D0.l, 1),
    gsSPLight(&peach2639_seg5_lights_050087D0.a, 2),
    gsSPVertex(peach2639_seg5_vertex_050087E8, 12, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  1,  0,  3, 0x0),
...
const Gfx peach2639_seg5_dl_05008A10[] = {
    gsSPVertex(peach2639_seg5_vertex_050088A8, 13, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  2,  4, 0x0),
...
const Gfx peach2639_seg5_dl_05008AB0[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGBFADE, G_CC_MODULATERGBFADE),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_ON),
    ...
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 0, G_TX_RENDERTILE, 0, G_TX_CLAMP, 5, G_TX_NOLOD, G_TX_CLAMP, 5, G_TX_NOLOD),
    gsDPSetTileSize(0, 0, 0, (32 - 1) << G_TEXTURE_IMAGE_FRAC, (32 - 1) << G_TEXTURE_IMAGE_FRAC),
    gsSPDisplayList(peach2639_seg5_dl_05008978),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_OFF),
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADEFADEA, G_CC_SHADEFADEA),
    gsSPDisplayList(peach2639_seg5_dl_05008A10),
    gsDPPipeSync(),
    gsSPEndDisplayList(),
};

// 0x05008B20
static const Lights1 peach2639_seg5_lights_05008B20 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x05008B38
static const Vtx peach2639_seg5_vertex_05008B38[] = {
...
const Gfx peach2639_seg5_dl_05008C18[] = {
    gsSPLight(&peach2639_seg5_lights_05008B20.l, 1),
    gsSPLight(&peach2639_seg5_lights_05008B20.a, 2),
    gsSPVertex(peach2639_seg5_vertex_05008B38, 14, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  2,  3,  4, 0x0),
...
const Gfx peach2639_seg5_dl_05008CF8[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADEFADEA, G_CC_SHADEFADEA),
    gsSPDisplayList(peach2639_seg5_dl_05008C18),
    gsDPPipeSync(),
    gsSPEndDisplayList(),
};

// 0x05008D20
static const Lights1 peach2639_seg5_lights_05008D20 = gdSPDefLights1(
    0x0b, 0x1a, 0x67,
    0x16, 0x35, 0xce, 0x28, 0x28, 0x28
);

// 0x05008D38
static const Vtx peach2639_seg5_vertex_05008D38[] = {
...
const Gfx peach2639_seg5_dl_05008E38[] = {
    gsSPLight(&peach2639_seg5_lights_05008D20.l, 1),
    gsSPLight(&peach2639_seg5_lights_05008D20.a, 2),
    gsSPVertex(peach2639_seg5_vertex_05008D38, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  1,  0, 0x0),
...
const Gfx peach2639_seg5_dl_05008F20[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADEFADEA, G_CC_SHADEFADEA),
    gsSPDisplayList(peach2639_seg5_dl_05008E38),
    gsDPPipeSync(),
    gsSPEndDisplayList(),
};

// 0x05008F48
static const Lights1 peach2639_seg5_lights_05008F48 = gdSPDefLights1(
    0x0b, 0x1a, 0x67,
    0x16, 0x35, 0xce, 0x28, 0x28, 0x28
);

// 0x05008F60
static const Vtx peach2639_seg5_vertex_05008F60[] = {
...
const Gfx peach2639_seg5_dl_05009060[] = {
    gsSPLight(&peach2639_seg5_lights_05008F48.l, 1),
    gsSPLight(&peach2639_seg5_lights_05008F48.a, 2),
    gsSPVertex(peach2639_seg5_vertex_05008F60, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
...
const Gfx peach2639_seg5_dl_05009148[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADEFADEA, G_CC_SHADEFADEA),
    gsSPDisplayList(peach2639_seg5_dl_05009060),
    gsDPPipeSync(),
    gsSPEndDisplayList(),
};

// 0x05009170
static const Lights1 peach2639_seg5_lights_05009170 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x05009188
static const Vtx peach2639_seg5_vertex_05009188[] = {
...
// 0x05009288
static const Vtx peach2639_seg5_vertex_05009288[] = {
...
const Gfx peach2639_seg5_dl_05009388[] = {
    gsSPLight(&peach2639_seg5_lights_05009170.l, 1),
    gsSPLight(&peach2639_seg5_lights_05009170.a, 2),
    gsSPVertex(peach2639_seg5_vertex_05009188, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  0,  2, 0x0),
    ...
    gsSPVertex(peach2639_seg5_vertex_05009288, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  1,  3,  2, 0x0),
...
const Gfx peach2639_seg5_dl_05009500[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADEFADEA, G_CC_SHADEFADEA),
    gsSPDisplayList(peach2639_seg5_dl_05009388),
    gsDPPipeSync(),
    gsSPEndDisplayList(),
};

// 0x05009528
static const Lights1 peach2639_seg5_lights_05009528 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x05009540
static const Vtx peach2639_seg5_vertex_05009540[] = {
...
// 0x05009640
static const Vtx peach2639_seg5_vertex_05009640[] = {
    {{{    17,     -3,     24}, 0, {     0,      0}, {0xee, 0x30, 0x73, 0xff}}},
    {{{    43,    -15,     35}, 0, {     0,      0}, {0xfe, 0x2a, 0x77, 0xff}}},
...
// 0x05009740
static const Vtx peach2639_seg5_vertex_05009740[] = {
    {{{    47,    -17,    -18}, 0, {     0,      0}, {0x1f, 0xab, 0xa8, 0xff}}},
...
const Gfx peach2639_seg5_dl_050097C0[] = {
    gsSPLight(&peach2639_seg5_lights_05009528.l, 1),
    gsSPLight(&peach2639_seg5_lights_05009528.a, 2),
    gsSPVertex(peach2639_seg5_vertex_05009540, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  2,  4, 0x0),
    ...
    gsSPVertex(peach2639_seg5_vertex_05009640, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  2,  3,  0, 0x0),
    ...
    gsSPVertex(peach2639_seg5_vertex_05009740, 8, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  1,  0, 0x0),
...
const Gfx peach2639_seg5_dl_05009940[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADEFADEA, G_CC_SHADEFADEA),
    gsSPDisplayList(peach2639_seg5_dl_050097C0),
    gsDPPipeSync(),
    gsSPEndDisplayList(),
};

// 0x05009968
static const Lights1 peach2639_seg5_lights_05009968 = gdSPDefLights1(
    0x7f, 0x7f, 0x7f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x05009980
static const Vtx peach2639_seg5_vertex_05009980[] = {
...
// 0x05009A70
static const Vtx peach2639_seg5_vertex_05009A70[] = {
...
// 0x05009B60
static const Vtx peach2639_seg5_vertex_05009B60[] = {
...
// 0x05009C60
static const Vtx peach2639_seg5_vertex_05009C60[] = {
...
// 0x05009D50
static const Vtx peach2639_seg5_vertex_05009D50[] = {
    {{{   124,      3,   -182}, 0, {  3788,    584}, {0xcd, 0xff, 0x8d, 0xff}}},
    {{{   -10,      0,   -101}, 0, {  3806,    -88}, {0xaf, 0xfe, 0x9f, 0xff}}},
    {{{    52,    106,   -109}, 0, {  3178,    228}, {0xc2, 0x4c, 0xb1, 0xff}}},
    {{{    59,   -104,   -109}, 0, {  4420,    262}, {0xc6, 0xb1, 0xb1, 0xff}}},
...
const Gfx peach2639_seg5_dl_05009E20[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, peach2639_seg5_texture_05004028),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPLight(&peach2639_seg5_lights_05009968.l, 1),
    gsSPLight(&peach2639_seg5_lights_05009968.a, 2),
    gsSPVertex(peach2639_seg5_vertex_05009980, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  2,  3,  0, 0x0),
    ...
    gsSPVertex(peach2639_seg5_vertex_05009A70, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    ...
    gsSPVertex(peach2639_seg5_vertex_05009B60, 16, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    ...
    gsSPVertex(peach2639_seg5_vertex_05009C60, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  2,  1, 0x0),
    ...
    gsSPVertex(peach2639_seg5_vertex_05009D50, 13, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  1,  0, 0x0),
...
const Gfx peach2639_seg5_dl_0500A0A8[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGBFADE, G_CC_MODULATERGBFADE),
    ...
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 0, G_TX_RENDERTILE, 0, G_TX_CLAMP, 5, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, 5, G_TX_NOLOD),
    gsDPSetTileSize(0, 0, 0, (32 - 1) << G_TEXTURE_IMAGE_FRAC, (32 - 1) << G_TEXTURE_IMAGE_FRAC),
    gsSPDisplayList(peach2639_seg5_dl_05009E20),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_OFF),
    gsDPPipeSync(),
...
const Gfx peach2639_seg5_us_dl_0500A188[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGBFADE, G_CC_MODULATERGBFADE),
    gsSPClearGeometryMode(G_CULL_BACK),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
