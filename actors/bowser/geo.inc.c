            ...
            GEO_OPEN_NODE(),
               ...
               GEO_OPEN_NODE(),
                  ...
                  GEO_OPEN_NODE(),
                     ...
                     //snowboard
                     GEO_SWITCH_CASE(2, geo_is_level_b1),
                     GEO_OPEN_NODE(),
         ...
         GEO_OPEN_NODE(),
            ...
            GEO_OPEN_NODE(),
               ...
               GEO_OPEN_NODE(),
                  GEO_ANIMATED_PART(LAYER_OPAQUE, 49, 0, 0, NULL),
                  GEO_OPEN_NODE(),
                     GEO_ANIMATED_PART(LAYER_OPAQUE, 0, 0, 0, bowser_seg6_dl_0603DFB0), //right hand (to god that is all that i am, etc etc)
                     GEO_OPEN_NODE(),
                        GEO_ASM(0, geo_bowser_hand_location_update),
                     GEO_CLOSE_NODE(),
                  GEO_CLOSE_NODE(),
