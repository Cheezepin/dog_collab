...
// 0x06021388
UNUSED static const Lights1 chain_chomp_bowser_lights_unused1 = gdSPDefLights1(
    0x3f, 0x3f, 0x3f,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x060213A0
UNUSED static const Lights1 chain_chomp_bowser_lights_unused2 = gdSPDefLights1(
    0x03, 0x03, 0x05,
    0x0d, 0x0f, 0x16, 0x28, 0x28, 0x28
);

// 0x060213B8
UNUSED static const Lights1 chain_chomp_bowser_lights_unused3 = gdSPDefLights1(
    0x25, 0x00, 0x00,
    0x96, 0x00, 0x00, 0x28, 0x28, 0x28
);

// 0x060213D0
ALIGNED8 static const Texture chain_chomp_bowser_seg6_texture_060213D0[] = {
#include "actors/chain_chomp_bowser/chain_chomp_bowser_bright_shine.rgba16.inc.c"
};

// 0x06021BD0
ALIGNED8 static const Texture chain_chomp_bowser_seg6_texture_06021BD0[] = {
#include "actors/chain_chomp_bowser/chain_chomp_bowser_dull_shine.rgba16.inc.c"
};

// 0x060223D0
ALIGNED8 static const Texture chain_chomp_bowser_seg6_texture_060223D0[] = {
#include "actors/chain_chomp_bowser/chain_chomp_bowser_tongue.rgba16.inc.c"
};

// 0x06022BD0
ALIGNED8 static const Texture chain_chomp_bowser_seg6_texture_06022BD0[] = {
#include "actors/chain_chomp_bowser/chain_chomp_bowser_tooth.rgba16.inc.c"
};

// 0x060233D0
ALIGNED8 static const Texture chain_chomp_bowser_seg6_texture_060233D0[] = {
#include "actors/chain_chomp_bowser/chain_chomp_bowser_eye.rgba16.inc.c"
};

// 0x06023BD0
static const Vtx chain_chomp_bowser_seg6_vertex_06023BD0[] = {
...
// 0x06023C20
static const Vtx chain_chomp_bowser_seg6_vertex_06023C20[] = {
...
// 0x06023D20
static const Vtx chain_chomp_bowser_seg6_vertex_06023D20[] = {
    {{{   291,   -410,    291}, 0, {   600,    640}, {0xff, 0xff, 0xff, 0xff}}},
...
// 0x06023E10
static const Vtx chain_chomp_bowser_seg6_vertex_06023E10[] = {
...
// 0x06023F00
static const Vtx chain_chomp_bowser_seg6_vertex_06023F00[] = {
...
const Gfx chain_chomp_bowser_seg6_dl_06024000[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, chain_chomp_bowser_seg6_texture_060223D0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPVertex(chain_chomp_bowser_seg6_vertex_06023BD0, 5, 0),
...
const Gfx chain_chomp_bowser_seg6_dl_06024040[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, chain_chomp_bowser_seg6_texture_060213D0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPVertex(chain_chomp_bowser_seg6_vertex_06023C20, 16, 0),
    ...
    gsSPVertex(chain_chomp_bowser_seg6_vertex_06023D20, 15, 0),
    ...
    gsSPVertex(chain_chomp_bowser_seg6_vertex_06023E10, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  1,  0, 0x0),
    gsSP2Triangles( 0,  2,  4, 0x0,  5,  6,  7, 0x0),
    gsSP2Triangles( 5,  8,  6, 0x0,  9,  8,  5, 0x0),
    gsSP2Triangles(10, 11,  9, 0x0,  9, 11,  8, 0x0),
    gsSP1Triangle(12, 13, 14, 0x0),
    gsSPVertex(chain_chomp_bowser_seg6_vertex_06023F00, 16, 0),
...
const Gfx chain_chomp_bowser_seg6_dl_06024240[] = {
    gsDPPipeSync(),
    ...
    gsSPDisplayList(chain_chomp_bowser_seg6_dl_06024000),
    gsDPTileSync(),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 0, G_TX_RENDERTILE, 0, G_TX_CLAMP, 5, G_TX_NOLOD, G_TX_CLAMP, 5, G_TX_NOLOD),
    gsDPSetTileSize(0, 0, 0, (32 - 1) << G_TEXTURE_IMAGE_FRAC, (32 - 1) << G_TEXTURE_IMAGE_FRAC),
    gsSPDisplayList(chain_chomp_bowser_seg6_dl_06024040),
...
// 0x060242D0
static const Vtx chain_chomp_bowser_seg6_vertex_060242D0[] = {
...
// 0x060243B0
static const Vtx chain_chomp_bowser_seg6_vertex_060243B0[] = {
...
// 0x060244B0
static const Vtx chain_chomp_bowser_seg6_vertex_060244B0[] = {
    {{{     0,    223,   -536}, 0, { -1262,   -214}, {0xff, 0xff, 0xff, 0xff}}},
    {{{   411,      0,   -410}, 0, {  -280,    -34}, {0xff, 0xff, 0xff, 0xff}}},
...
// 0x060245B0
static const Vtx chain_chomp_bowser_seg6_vertex_060245B0[] = {
...
// 0x060246B0
static const Vtx chain_chomp_bowser_seg6_vertex_060246B0[] = {
...
const Gfx chain_chomp_bowser_seg6_dl_06024700[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, chain_chomp_bowser_seg6_texture_06021BD0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPVertex(chain_chomp_bowser_seg6_vertex_060242D0, 14, 0),
    ...
    gsSPVertex(chain_chomp_bowser_seg6_vertex_060243B0, 16, 0),
...
const Gfx chain_chomp_bowser_seg6_dl_06024900[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, chain_chomp_bowser_seg6_texture_060223D0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPVertex(chain_chomp_bowser_seg6_vertex_060246B0, 5, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
...
const Gfx chain_chomp_bowser_seg6_dl_06024940[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGB, G_CC_MODULATERGB),
    gsSPClearGeometryMode(G_LIGHTING),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    ...
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 0, G_TX_RENDERTILE, 0, G_TX_CLAMP, 5, G_TX_NOLOD, G_TX_CLAMP, 5, G_TX_NOLOD),
    gsDPSetTileSize(0, 0, 0, (32 - 1) << G_TEXTURE_IMAGE_FRAC, (32 - 1) << G_TEXTURE_IMAGE_FRAC),
    gsSPDisplayList(chain_chomp_bowser_seg6_dl_06024700),
    gsDPTileSync(),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 0, G_TX_RENDERTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, 5, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, 5, G_TX_NOLOD),
    gsDPSetTileSize(0, 0, 0, (32 - 1) << G_TEXTURE_IMAGE_FRAC, (32 - 1) << G_TEXTURE_IMAGE_FRAC),
    gsSPDisplayList(chain_chomp_bowser_seg6_dl_06024900),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_OFF),
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADE, G_CC_SHADE),
    gsSPSetGeometryMode(G_LIGHTING),
...
// 0x060249D0
static const Lights1 chain_chomp_bowser_seg6_lights_060249D0 = gdSPDefLights1(
    0x66, 0x66, 0x66,
    0xff, 0xff, 0xff, 0x28, 0x28, 0x28
);

// 0x060249E8
static const Vtx chain_chomp_bowser_seg6_vertex_060249E8[] = {
...
const Gfx chain_chomp_bowser_seg6_dl_06024AA8[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, chain_chomp_bowser_seg6_texture_060233D0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPLight(&chain_chomp_bowser_seg6_lights_060249D0.l, 1),
    gsSPLight(&chain_chomp_bowser_seg6_lights_060249D0.a, 2),
    gsSPVertex(chain_chomp_bowser_seg6_vertex_060249E8, 12, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
...
const Gfx chain_chomp_bowser_seg6_dl_06024B00[] = {
    gsDPPipeSync(),
    ...
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 0, G_TX_RENDERTILE, 0, G_TX_CLAMP, 5, G_TX_NOLOD, G_TX_CLAMP, 5, G_TX_NOLOD),
    gsDPSetTileSize(0, 0, 0, (32 - 1) << G_TEXTURE_IMAGE_FRAC, (32 - 1) << G_TEXTURE_IMAGE_FRAC),
    gsSPDisplayList(chain_chomp_bowser_seg6_dl_06024AA8),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_OFF),
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADE, G_CC_SHADE),
...
// 0x06024B70
static const Vtx chain_chomp_bowser_seg6_vertex_06024B70[] = {
...
// 0x06024C60
static const Vtx chain_chomp_bowser_seg6_vertex_06024C60[] = {
...
const Gfx chain_chomp_bowser_seg6_dl_06024CF0[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, chain_chomp_bowser_seg6_texture_06022BD0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPVertex(chain_chomp_bowser_seg6_vertex_06024B70, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    gsSP2Triangles( 6,  7,  8, 0x0,  9, 10, 11, 0x0),
    gsSP1Triangle(12, 13, 14, 0x0),
    gsSPVertex(chain_chomp_bowser_seg6_vertex_06024C60, 9, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
...
const Gfx chain_chomp_bowser_seg6_dl_06024D60[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGB, G_CC_MODULATERGB),
    ...
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 0, G_TX_RENDERTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, 5, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, 5, G_TX_NOLOD),
    gsDPSetTileSize(0, 0, 0, (32 - 1) << G_TEXTURE_IMAGE_FRAC, (32 - 1) << G_TEXTURE_IMAGE_FRAC),
    gsSPDisplayList(chain_chomp_bowser_seg6_dl_06024CF0),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_OFF),
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADE, G_CC_SHADE),
...
// 0x06024DD0
static const Vtx chain_chomp_bowser_seg6_vertex_06024DD0[] = {
...
// 0x06024EC0
static const Vtx chain_chomp_bowser_seg6_vertex_06024EC0[] = {
...
const Gfx chain_chomp_bowser_seg6_dl_06024F50[] = {
    gsDPSetTextureImage(G_IM_FMT_RGBA, G_IM_SIZ_16b, 1, chain_chomp_bowser_seg6_texture_06022BD0),
    gsDPLoadSync(),
    gsDPLoadBlock(G_TX_LOADTILE, 0, 0, 32 * 32 - 1, CALC_DXT(32, G_IM_SIZ_16b_BYTES)),
    gsSPVertex(chain_chomp_bowser_seg6_vertex_06024DD0, 15, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    gsSP2Triangles( 6,  7,  8, 0x0,  9, 10, 11, 0x0),
    gsSP1Triangle(12, 13, 14, 0x0),
    gsSPVertex(chain_chomp_bowser_seg6_vertex_06024EC0, 9, 0),
    gsSP2Triangles( 0,  1,  2, 0x0,  3,  4,  5, 0x0),
    gsSP1Triangle( 6,  7,  8, 0x0),
    gsSPEndDisplayList(),
};
...
const Gfx chain_chomp_bowser_seg6_dl_06024FC0[] = {
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_MODULATERGB, G_CC_MODULATERGB),
    gsSPClearGeometryMode(G_LIGHTING | G_CULL_BACK),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 0, 0, G_TX_LOADTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD),
    ...
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 0, G_TX_RENDERTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, 5, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, 5, G_TX_NOLOD),
    gsDPSetTileSize(0, 0, 0, (32 - 1) << G_TEXTURE_IMAGE_FRAC, (32 - 1) << G_TEXTURE_IMAGE_FRAC),
    gsSPDisplayList(chain_chomp_bowser_seg6_dl_06024F50),
    gsSPTexture(0xFFFF, 0xFFFF, 0, G_TX_RENDERTILE, G_OFF),
    gsDPPipeSync(),
    gsDPSetCombineMode(G_CC_SHADE, G_CC_SHADE),
    gsSPSetGeometryMode(G_LIGHTING | G_CULL_BACK),
