...
static const Vtx impact_ring_seg6_vertex_0601C9D0[] = {
    {{{     0,      0,     -5}, 0, {   992,      0}, {0xff, 0x00, 0x00, 0xff}}},
    {{{    -5,      0,      5}, 0, {     0,   2016}, {0xff, 0x00, 0x00, 0xff}}},
    {{{     0,      0,      5}, 0, {   992,   2016}, {0xff, 0x00, 0x00, 0xff}}},
    {{{    -5,      0,     -5}, 0, {     0,      0}, {0xff, 0x00, 0x00, 0xff}}},
};

// 0x0601CA10
static const Vtx impact_ring_seg6_vertex_0601CA10[] = {
    {{{     5,      0,     -5}, 0, {   992,      0}, {0xff, 0x00, 0x00, 0xff}}},
    {{{     0,      0,      5}, 0, {     0,   2016}, {0xff, 0x00, 0x00, 0xff}}},
    {{{     5,      0,      5}, 0, {   992,   2016}, {0xff, 0x00, 0x00, 0xff}}},
    {{{     0,      0,     -5}, 0, {     0,      0}, {0xff, 0x00, 0x00, 0xff}}},
};
