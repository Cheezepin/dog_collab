...
void bhv_hidden_star_init(void) {
    ...
    if (remainingTriggers == 0) {
        ...
        if (gCurrLevelNum == LEVEL_BITDW) starObj = spawn_object_abs_with_rot(o, 0, MODEL_RAINBOW_STAR, bhvStar, o->oPosX, o->oPosY, o->oPosZ, 0, 0, 0);
        else starObj = spawn_object_abs_with_rot(o, 0, MODEL_STAR, bhvStar, o->oPosX, o->oPosY, o->oPosZ, 0, 0, 0);
