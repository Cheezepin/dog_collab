...
struct HubSelection hubSelections[3][6] = {
    {
        ...
        {0x2F00, 0xF800, 9500.0f, 0x2B00, 0x500,  5512.0f, 0x1000, TEXT_C1I, TEXT_C1, TEXT_C1A, 0x2},
        {0x4000, 0x1100, 8795.0f, 0x3E00, 0x1F00, 5512.0f, 0x0000, TEXT_C2I, TEXT_C2, TEXT_C2A, 0x3},
        {0x4800, 0x400,  7184.0f, 0x3E00, 0x500,  5000.0f, 0x0000, TEXT_C3I, TEXT_C3, TEXT_C3A, 0x4},
        {0x3C00, 0xE400, 6928.0f, 0x3B00, 0xF900, 3976.0f, 0x1000, TEXT_C4I, TEXT_C4, TEXT_C4A, 0x5},
        {0x4700, 0x0,    8976.0f, 0x5200, 0x2100, 6536.0f, 0x1C00, TEXT_B1I, TEXT_B1, TEXT_B1A, 0x6},
    },
    {
        {0x9300, 0x1400, 6807.0f, 0x8B00, 0x2100, 5120.0f, 0xF800, TEXT_C5I, TEXT_C5, TEXT_C5A, 0x1},
        {0x9B80, 0xFB00, 8343.0f, 0x9500, 0x1B00, 5632.0f, 0x0000, TEXT_C6I, TEXT_C6, TEXT_C6A, 0x2},
        {0xAE00, 0x400,  6551.0f, 0xAC00, 0xD00,  5120.0f, 0x0000, TEXT_C7I, TEXT_C7, TEXT_C7A, 0x3},
        {0xB000, 0x1540, 7319.0f, 0xAE30, 0x2060, 5120.0f, 0x0000, TEXT_B2I, TEXT_B2, TEXT_B2A, 0x4},
        NULL_ENTRY,
        NULL_ENTRY,
    },
    {
